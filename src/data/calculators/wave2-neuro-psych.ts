...
export const wave2NeuroPsychCalcs: Calculator[] = [
  ...
  },
  {
    ...
    inputs: [
      ...
      numberInput('q5', '5. Days in the last 3 months missed family, social, or leisure activities because of headaches', {
        ...
        max: 90,
        exampleValue: 0,
        helpText: 'Count only days missed from family, social or leisure activities; do not subtract days already recorded in Q1–Q4.',
      }),
  ...
  },
  {
    ...
    inputs: [
      ...
      ], undefined, 'Choose the analyte the lab actually reported — total vs free phenytoin, valproate total, or oxcarbazepine\'s MHD metabolite — because each has its own reference range.'),
  ...
  },
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose \'Interactive 11-item examination\' to answer the items, or \'Direct score override\' to enter a total (0–30) from a paper form.'),
      ...
      ], 'hs', 'Education stratum selects the cut-offs: ≥HS uses 27–30 normal and 21–26 MCI; <HS uses 25–30 normal and 20–24 MCI.'),
      selectInput('q1_day', '1. What day of the week is it?', [
        { label: '0 — Incorrect', value: 0 },
        { label: '1 — Correct', value: 1 },
      ], 1, '1 point for the correct day of the week.'),
      selectInput('q2_year', '2. What is the year?', [
        { label: '0 — Incorrect', value: 0 },
        { label: '1 — Correct', value: 1 },
      ], 1, '1 point for the correct year.'),
      ...
      ], 8, 'Story recall scored 2 points per correct answer on the four Jill/stockbroker questions (name, occupation, timing, state), maximum 8.'),
  ...
  },
  {
    ...
    inputs: [
      selectInput('entryMode', 'Entry mode', [
        ...
        { label: 'Direct score override', value: 'direct' },
      ], 'survey', 'Choose \'Interactive 10-item clinician rating\' to score each item, or \'Direct score override\' to enter a total (0–60).'),
      ...
      ], 2, 'Item 1 apparent sadness: 0–6 on what you observe (facial expression, posture, weeping) over the past week, independent of what the patient reports.'),
      ...
      ], 2, 'Item 2 reported sadness: the patient\'s own account of low mood over the past week, rated 0–6 separately from observed sadness.'),
      ...
      ], 2, 'Item 3 inner tension: edginess, ill-defined dread or panic (0 = placid, 6 = unrelenting dread or overwhelming panic).'),
      ...
      ], 2, 'Item 4 reduced sleep: shortened duration or depth compared with the patient\'s usual sleep (0 = sleeps as usual, 6 = under 2–3 hours).'),
      ...
      ], 2, 'Item 6 concentration: difficulty collecting thoughts and sustaining attention (0 = none, 6 = cannot read or converse without great difficulty).'),
      ...
      ], 2, 'Item 7 lassitude: difficulty initiating ordinary activity, scored on inertia rather than on fatigue alone (0 = hardly any difficulty).'),
      ...
      ], 2, 'Item 8 inability to feel: loss of interest and emotional blunting towards people and surroundings (0 = normal reactivity, 6 = total emotional paralysis).'),
      ...
      ], 1, 'Item 9 pessimistic thoughts: guilt and inferiority, with 4+ for persistent self-accusation and 6 for delusional guilt or ideas of ruin.'),
      ...
      ], 1, 'Item 10 suicidal thoughts: 0 = enjoys life to 6 = explicit plans and active preparation; any score of 2 or more warrants a documented risk assessment.'),
...

  {
    ...
    inputs: [
      selectInput('entryMode', 'Entry mode', [
        ...
        { label: 'Direct score override', value: 'direct' },
      ], 'survey', 'Choose \'Interactive 17-item rating (HAM-D 17)\' to score each item, or \'Direct score override\' to enter a total (0–52).'),
      ...
      ], 2, 'Item 1 depressed mood: 0 = absent to 4 = these feelings dominate speech and behaviour; rate the past week.'),
      ...
      ], 1, 'Item 2 guilt: 1 = self-reproach, 2 = rumination over past errors, 3 = illness felt as punishment, 4 = accusatory or denunciatory hallucinations.'),
      ...
      ], 1, 'Item 4 early insomnia: 1 = occasional difficulty taking more than 30 minutes to fall asleep, 2 = nightly difficulty.'),
      ...
      ], 1, 'Item 5 middle insomnia: any waking and getting out of bed scores 2, except getting up to void.'),
      ...
      ], 1, 'Item 6 late insomnia: 1 = wakes in the early hours but returns to sleep, 2 = cannot fall asleep again after getting up.'),
      ...
      ], 2, 'Item 7 work and activities: 4 = has stopped working because of the current illness.'),
      ...
      ], 1, 'Item 8 retardation: rate slowness of speech and thought observed at interview, from slight (1) to complete stupor (4).'),
      ...
      ], 1, 'Item 9 agitation: 1 = fidgetiness, 2 = playing with hands or hair, 3 = cannot sit still, 4 = hand-wringing, nail- or lip-biting.'),
      ...
      ], 2, 'Item 10 psychic anxiety: subjective tension and worry; 3 = apprehensive attitude visible in face or speech, 4 = fears voiced without being asked.'),
      ...
      ], 1, 'Item 11 somatic anxiety: physical concomitants (GI, cardiovascular, respiratory, urinary, sweating), 4 = incapacitating.'),
      ...
      ], 1, 'Item 12 gastrointestinal somatic: 1 = appetite loss but eating unaided, 2 = needs urging or laxatives or medication for the bowels.'),
      ...
      ], 1, 'Item 13 general somatic: any clear-cut symptom such as limb heaviness, backache or headache scores 2.'),
      selectInput('hamd14', '14. Genital symptoms (loss of libido, menstrual disturbances)', [
        { label: '0 — Absent', value: 0 },
        { label: '1 — Mild', value: 1 },
        { label: '2 — Severe', value: 2 },
      ], 1, 'Item 14 genital symptoms: loss of libido or menstrual disturbance — 0 absent, 1 mild, 2 severe.'),
      ...
      ], 0, 'Item 15 hypochondriasis: 1 = bodily self-absorption, 2 = preoccupation with health, 3 = frequent complaints, 4 = hypochondriacal delusions.'),
      ...
      ], 0, 'Item 16 loss of weight: 1 = probable loss or more than 1 lb/week, 2 = definite loss or more than 2 lb/week.'),
      ...
      ], 0, 'Item 17 insight: 0 = acknowledges depression and illness, 1 = attributes it to external causes, 2 = denies being ill at all.'),
...

  {
    ...
    inputs: [
      selectInput('entryMode', 'Entry mode', [
        ...
        { label: 'Direct score override', value: 'direct' },
      ], 'survey', 'Choose \'Interactive 14-item clinician interview\' to score each item, or \'Direct score override\' to enter a total (0–56).'),
      ...[
        {
          title: '1. Anxious mood (worries, anticipation of the worst, fearful anticipation, irritability)',
          helpText: 'Item 1 anxious mood: worries, anticipation of the worst, fearful anticipation and irritability, 0–4 over the past week.',
        },
        {
          title: '2. Tension (feelings of tension, fatigability, startle response, moved to tears easily, trembling)',
          helpText: 'Item 2 tension: subjective tension, fatigability, startle response and tearfulness; 4 = incapacitating.',
        },
        {
          title: '3. Fears (of dark, strangers, being left alone, animals, traffic, crowds)',
          helpText: 'Item 3 fears: score actual phobic fears (dark, strangers, being alone, animals, traffic, crowds), not general worry.',
        },
        {
          title: '4. Insomnia (difficulty falling asleep, broken sleep, unrefreshing sleep, fatigue on waking)',
          helpText: 'Item 4 insomnia: difficulty falling asleep, broken sleep, unrefreshing sleep and fatigue on waking.',
        },
        {
          title: '5. Intellectual / cognitive (difficulty in concentration, poor memory)',
          helpText: 'Item 5 intellectual: difficulty concentrating and poor memory, rated on the past week, 0–4.',
        },
        {
          title: '6. Depressed mood (loss of interest, lack of pleasure in hobbies, depression, early waking)',
          helpText: 'Item 6 depressed mood: loss of interest, anhedonia and early waking — this is the depressive overlap item.',
        },
        {
          title: '7. Somatic: muscular (pains and aches, twitching, stiffness, myoclonic jerks, teeth grinding)',
          helpText: 'Item 7 muscular: aches and pains, twitching, stiffness, myoclonic jerks and teeth grinding.',
        },
        {
          title: '8. Somatic: sensory (tinnitus, blurring of vision, hot and cold flushes, weakness, prickling)',
          helpText: 'Item 8 sensory: tinnitus, blurred vision, hot and cold flushes, weakness and prickling sensations.',
        },
        {
          title: '9. Cardiovascular symptoms (tachycardia, palpitations, pain in chest, throbbing of vessels)',
          helpText: 'Item 9 cardiovascular: tachycardia, palpitations, chest pain and throbbing of vessels.',
        },
        {
          title: '10. Respiratory symptoms (pressure or constriction in chest, choking feelings, sighing, dyspnea)',
          helpText: 'Item 10 respiratory: chest pressure or constriction, choking feelings, sighing and dyspnoea.',
        },
        {
          title: '11. Gastrointestinal symptoms (dysphagia, wind, dyspepsia, abdominal pain, nausea, vomiting, loose bowels)',
          helpText: 'Item 11 gastrointestinal: dysphagia, wind, dyspepsia, abdominal pain, nausea, vomiting and loose bowels.',
        },
        {
          title: '12. Genitourinary symptoms (frequency, urgency, amenorrhea, menorrhagia, loss of libido, premature ejaculation)',
          helpText: 'Item 12 genitourinary: urinary frequency and urgency, amenorrhoea, menorrhagia and sexual symptoms.',
        },
        {
          title: '13. Autonomic symptoms (dry mouth, flushing, pallor, sweating, giddiness, tension headache)',
          helpText: 'Item 13 autonomic: dry mouth, flushing, pallor, sweating, giddiness and tension headache.',
        },
        {
          title: '14. Behavior at interview (fidgeting, restlessness, tremor of hands, furrowed brow, strained face, sighing)',
          helpText: 'Item 14 behaviour at interview: observed fidgeting, restlessness, hand tremor, furrowed brow, strained face and sighing.',
        },
      ].map((item, i) =>
        selectInput(`hama_${i + 1}`, item.title, [
          { label: '0 — Not present', value: 0 },
          { label: '1 — Mild', value: 1 },
          { label: '2 — Moderate', value: 2 },
          { label: '3 — Severe', value: 3 },
          { label: '4 — Very severe (incapacitating)', value: 4 },
        ], i < 6 ? 2 : 1, item.helpText),
      ),
  ...
  },
  {
    ...
    inputs: [
      selectInput('entryMode', 'Entry mode', [
        ...
        { label: 'Direct score override', value: 'direct' },
      ], 'survey', 'Choose \'Interactive 11-item clinician interview\' to score each item, or \'Direct score override\' to enter a total (0–60).'),
      ...
      ], 1, 'Item 1 elevated mood: 1 = possibly increased on questioning to 4 = euphoric with inappropriate laughter or singing.'),
      ...
      ], 1, 'Item 2 increased motor activity: 3 = hyperactive at times but can be calmed, 4 = continuous excitement that cannot be calmed.'),
      ...
      ], 1, 'Item 3 sexual interest: 3 = spontaneous sexual content or hypersexuality by report, 4 = overt sexual acts.'),
      ...
      ], 1, 'Item 4 sleep: 2 = more than an hour less sleep than usual, 3 = reports a decreased need for sleep, 4 = denies any need for sleep.'),
      ...
      ], 2, 'Item 5 irritability is double-weighted — only 0, 2, 4, 6 or 8 points; 8 = hostile and uncooperative, interview impossible.'),
      ...
      ], 2, 'Item 6 speech rate and amount is double-weighted; 8 = pressured, uninterruptible, continuous speech.'),
      ...
      ], 1, 'Item 7 language-thought disorder: 1 = circumstantiality to 4 = incoherent speech, communication impossible.'),
      ...
      ], 2, 'Item 8 content is double-weighted: 4 = special projects or hyper-religiosity, 6 = grandiose or paranoid ideas, 8 = delusions or hallucinations.'),
      ...
      ], 0, 'Item 9 disruptive-aggressive behaviour is double-weighted: 6 = threatens the interviewer, 8 = assaultive or destructive.'),
      ...
      ], 0, 'Item 10 appearance: 2 = poorly groomed and moderately dishevelled or overdressed, 4 = completely unkempt or bizarre clothing.'),
      ...
      ], 1, 'Item 11 insight: 0 = admits illness and the need for treatment, 1 = admits illness but denies needing medication, 4 = denies any behaviour change.'),
  ...
  },
  {
    ...
    inputs: [
      selectInput('entryMode', 'Entry mode', [
        ...
        { label: 'Direct score override', value: 'direct' },
      ], 'survey', 'Choose \'Interactive 7-item questionnaire\' to rate each item, or \'Direct score override\' to enter a total (0–28).'),
      ...
      ], 2, 'Item 1 severity of difficulty falling asleep, 0–4 over the past 2 weeks.'),
      selectInput('isi2', '2. Difficulty staying asleep', [
        ...
        { label: '3 — Severe', value: 3 },
        { label: '4 — Very severe', value: 4 },
      ], 2, 'Item 2 severity of difficulty staying asleep, 0–4 over the past 2 weeks.'),
      selectInput('isi3', '3. Problems waking up too early', [
        ...
        { label: '3 — Severe', value: 3 },
        { label: '4 — Very severe', value: 4 },
      ], 2, 'Item 3 severity of waking up too early, 0–4 over the past 2 weeks.'),
      ...
      ], 2, 'Item 4 is worded as satisfaction, but the anchors already run 0 = very satisfied to 4 = very dissatisfied; add the value as entered, with no reverse scoring.'),
      ...
      ], 1, 'Item 5 how noticeable the sleep problem is to other people in terms of its impact on quality of life.'),
      ...
      ], 2, 'Item 6 how worried or distressed the patient is about the current sleep problem.'),
      selectInput('isi7', '7. Interference with daily functioning (e.g. daytime fatigue, ability to function at work/chores)', [
        ...
        { label: '3 — Much', value: 3 },
        { label: '4 — Very much', value: 4 },
      ], 1, 'Item 7 interference with daytime functioning, such as fatigue and the ability to work or do chores.'),
...

  {
    ...
    inputs: [
      selectInput('entryMode', 'Entry mode', [
        ...
        { label: 'Direct score override', value: 'direct' },
      ], 'survey', 'Choose \'Interactive 20-item questionnaire\' to rate each item, or \'Direct score override\' to enter a total (0–80).'),
      ...
      ], 2, 'Cluster B (intrusion). Memories must be repeated, unwanted and disturbing, so ordinary reminiscence does not count; rate the past month 0–4, and 2+ endorses the item.'),
      selectInput('pcl_2', '2. Repeated, disturbing dreams of the stressful experience', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 2, 'Cluster B (intrusion). Disturbing dreams of the stressful experience itself rather than of unrelated stressors; rated 0–4 over the past month, with 2+ counted as endorsed.'),
      selectInput('pcl_3', '3. Suddenly feeling or acting as if the stressful experience were actually happening again', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 2, 'Cluster B (intrusion). Covers flashbacks and dissociative re-experiencing, including feeling or acting as if the event were happening again; 0–4 for the past month, endorsed from 2.'),
      selectInput('pcl_4', '4. Feeling very upset when something reminded you of the stressful experience', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 2, 'Cluster B (intrusion). Intense emotional upset on exposure to reminders — distinct from the physical reactions in item 5; scored 0–4, endorsed from 2.'),
      selectInput('pcl_5', '5. Having strong physical reactions when something reminded you of the stressful experience (e.g., heart pounding, trouble breathing)', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 2, 'Cluster B (intrusion). The physiological response to reminders (heart pounding, breathlessness); rate 0–4 for the past month, endorsing at 2 or more.'),
      selectInput('pcl_6', '6. Avoiding memories, thoughts, or feelings related to the stressful experience', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 2, 'Cluster C (avoidance). Internal avoidance of memories, thoughts or feelings about the event; 0–4 over the past month, with 2 or more endorsing the symptom.'),
      selectInput('pcl_7', '7. Avoiding external reminders (e.g. people, places, conversations, activities, objects, or situations)', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 2, 'Cluster C (avoidance). External avoidance of people, places, conversations, activities, objects or situations; scored 0–4, endorsing from 2.'),
      selectInput('pcl_8', '8. Trouble remembering important parts of the stressful experience', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 2, 'Cluster D (negative cognitions and mood). Amnesia for important parts of the event, not ordinary forgetting; rate 0–4 and treat 2+ as endorsed.'),
      selectInput('pcl_9', '9. Having strong negative beliefs about yourself, other people, or the world', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster D (negative cognitions and mood). Persistent negative beliefs about yourself, other people or the world; 0–4 for the past month, endorsement threshold 2.'),
      selectInput('pcl_10', '10. Blaming yourself or someone else for the stressful experience or what happened after it', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster D (negative cognitions and mood). Blaming yourself or others for the event or its aftermath; rated 0–4, endorsed at 2 or more.'),
      selectInput('pcl_11', '11. Having strong negative feelings such as fear, horror, anger, guilt, or shame', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster D (negative cognitions and mood). Persistent fear, horror, anger, guilt or shame; 0–4 over the past month, endorsing from 2.'),
      selectInput('pcl_12', '12. Loss of interest in activities that you used to enjoy', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster D (negative cognitions and mood). Markedly diminished interest in activities previously enjoyed; scored 0–4, with 2+ endorsed.'),
      selectInput('pcl_13', '13. Feeling distant or cut off from other people', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster D (negative cognitions and mood). Feeling distant or cut off from other people; rate 0–4 for the past month, endorsed at 2 or more.'),
      selectInput('pcl_14', '14. Trouble experiencing positive feelings (e.g. being unable to feel happiness or love)', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster D (negative cognitions and mood). Trouble experiencing positive feelings such as happiness or love; 0–4, endorsement threshold 2.'),
      selectInput('pcl_15', '15. Irritable behavior, angry outbursts, or acting aggressively', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster E (arousal and reactivity). Irritable behaviour, angry outbursts or aggression; rated 0–4, with 2 or more endorsing the symptom.'),
      selectInput('pcl_16', '16. Taking too many risks or doing things that could cause you harm', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster E (arousal and reactivity). Taking too many risks or doing things that could cause harm; 0–4 over the past month, endorsed from 2.'),
      selectInput('pcl_17', '17. Being “superalert” or watchful or on guard', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster E (arousal and reactivity). Hypervigilance — being super-alert, watchful or on guard; rate 0–4 and treat 2+ as endorsed.'),
      selectInput('pcl_18', '18. Feeling jumpy or easily startled', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster E (arousal and reactivity). Exaggerated startle response — feeling jumpy or easily startled; scored 0–4, endorsed at 2 or more.'),
      selectInput('pcl_19', '19. Having difficulty concentrating', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster E (arousal and reactivity). Difficulty concentrating, including after reminders of the event; 0–4 over the past month, endorsement threshold 2.'),
      selectInput('pcl_20', '20. Trouble falling or staying asleep', [
        ...
        { label: '3 — Quite a bit (symptom endorsed)', value: 3 },
        { label: '4 — Extremely (symptom endorsed)', value: 4 },
      ], 1, 'Cluster E (arousal and reactivity). Trouble falling or staying asleep; rated 0–4, counting 2 or more as endorsed for the cluster algorithm.'),
