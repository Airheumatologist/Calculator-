...
export const wave4FormulasCalcs: Calculator[] = [
    ...
    evidence: {
      ...
      references: [
        ...
        },
        {
          ...
          citation: 'Harris JA, Benedict FG. Proc Natl Acad Sci U S A. 1918 (journal precursor of the 1919 Carnegie monograph)',
          year: 1918,
          pmid: '16576330',
        ...
        },
        {
          ...
          citation: 'Harris JA, Benedict FG. Carnegie Institution of Washington Publication No. 279. 1919',
          year: 1919,
  ...
  // ─── 4. Nitrogen balance ───────────────────────────────────────────────────
  {
    ...
    evidence: {
      ...
      references: [
        {
          title: 'Nutritional and metabolic assessment of the hospitalized patient',
          citation: 'Blackburn GL, Bistrian BR, Maini BS, Schlamm HT, Smith MF. JPEN. 1977',
          year: 1977,
          pmid: '98649',
  ...
  // ─── 5. Urea reduction ratio ───────────────────────────────────────────────
  {
    ...
    inputs: [
      numberInput('preBun', 'Pre-dialysis BUN', { unit: 'mg/dL', min: 10, max: 200, exampleValue: 60, helpText: 'URR = (pre − post)/pre × 100%. Common thrice-weekly target URR ≥65% (KDOQI teaching). Draw pre-BUN before dialysis starts.' }),
      numberInput('postBun', 'Post-dialysis BUN', { unit: 'mg/dL', min: 5, max: 150, exampleValue: 20, helpText: 'Slow-flow / stop-pump post-BUN sampling per unit protocol. Timing and rebound affect URR and Kt/V.' }),
    ],
    calculate(values) {
  ...
  // ─── 7. 4-2-1 hourly fluids ────────────────────────────────────────────────
  {
    ...
    inputs: [numberInput('weight', 'Weight', { unit: 'kg', unitKind: 'weight', min: 1, max: 200, step: 0.1, exampleValue: 20, helpText: '4 mL/kg/h for first 10 kg, 2 mL/kg/h for next 10 kg, 1 mL/kg/h for each kg above 20. Same as Holliday–Segar hourly.' })],
    calculate(values) {
  ...
  // ─── 8. Brooke burn formula ────────────────────────────────────────────────
  {
    ...
    evidence: {
      ...
      references: [
        {
          title: 'Fluid and electrolyte balance in burns (original Brooke formula)',
          citation: 'Reiss E, Stirman JA, Artz CP, Davis JH, Amspacher WH. JAMA. 1953',
          year: 1953,
          pmid: '13061267',
          doi: '10.1001/jama.1953.03690140017004',
        },
        {
          title: 'American Burn Association Clinical Practice Guidelines on Burn Shock Resuscitation',
          citation: 'Cartotto R et al. J Burn Care Res. 2024 (2 mL/kg/%TBSA starting point)',
          year: 2024,
          pmid: '38051821',
  ...
  // ─── 9. Lund–Browder ───────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      numberInput('armR', 'Right arm (whole) burned', { unit: '% of region', min: 0, max: 100, exampleValue: 0, helpText: 'Whole arm = upper arm 4 + forearm 3 + hand 2.5 = 9.5% TBSA. Enter % of this whole arm that is 2nd-/3rd-degree; 100 = entire arm including hand.' }),
      numberInput('armL', 'Left arm (whole) burned', { unit: '% of region', min: 0, max: 100, exampleValue: 0, helpText: 'Whole arm = 9.5% TBSA (upper arm 4 + forearm 3 + hand 2.5). Enter % of this whole arm that is 2nd-/3rd-degree; 100 = entire arm including hand.' }),
      numberInput('legR', 'Right leg (whole) burned', { unit: '% of region', min: 0, max: 100, exampleValue: 0, helpText: 'Whole leg = age-specific thigh + leg + foot 3.5. Enter % of this whole leg that is 2nd-/3rd-degree; 100 = entire leg. Buttocks are a separate field.' }),
      numberInput('legL', 'Left leg (whole) burned', { unit: '% of region', min: 0, max: 100, exampleValue: 0, helpText: 'Whole leg = age-specific thigh + leg + foot 3.5. Enter % of this whole leg that is 2nd-/3rd-degree; 100 = entire leg. Buttocks are a separate field.' }),
      numberInput('buttocks', 'Buttocks (both) burned', { unit: '% of region', min: 0, max: 100, exampleValue: 0, helpText: 'Both buttocks = 2.5% + 2.5% = 5% TBSA. Enter % of this combined region that is 2nd- or 3rd-degree; 100 = both buttocks fully burned.' }),
      numberInput('perineum', 'Perineum / genitalia burned', { unit: '% of region', min: 0, max: 100, exampleValue: 0, helpText: 'Genitalia = 1% TBSA. Enter % of this anatomic region that is 2nd- or 3rd-degree; 100 = entire region; do not enter % of whole-body TBSA.' }),
    ],
    calculate(values) {
      ...
      references: [
        {
          ...
          citation: 'Lund CC, Browder NC. Surg Gynecol Obstet. 1944;79:352–358',
          year: 1944,
        },
      ],
    },
  ...
  // ─── 10. Temp C ↔ F ────────────────────────────────────────────────────────
  {
    ...
    evidence: {
      ...
      references: [{ title: 'NIST Special Publication 811: Guide for the Use of the International System of Units (SI)', citation: 'Thompson A, Taylor BN. NIST SP 811. Gaithersburg: National Institute of Standards and Technology; 2008', year: 2008, url: 'https://www.nist.gov/pml/special-publication-811' }],
    },
  ...
  // ─── 11. Weight lb ↔ kg ────────────────────────────────────────────────────
  {
    ...
    evidence: {
      ...
      references: [{ title: 'NIST Special Publication 811: Guide for the Use of the International System of Units (SI)', citation: 'Thompson A, Taylor BN. NIST SP 811 (avoirdupois pound = 0.45359237 kg exactly)', year: 2008, url: 'https://www.nist.gov/pml/special-publication-811' }],
    },
  ...
  // ─── 12. Length in ↔ cm ────────────────────────────────────────────────────
  {
    ...
    evidence: {
      ...
      references: [{ title: 'NIST Special Publication 811: Guide for the Use of the International System of Units (SI)', citation: 'Thompson A, Taylor BN. NIST SP 811 (1 in = 2.54 cm exactly)', year: 2008, url: 'https://www.nist.gov/pml/special-publication-811' }],
    },
  ...
  // ─── 13. Pressure mmHg ↔ kPa ───────────────────────────────────────────────
  {
    ...
    evidence: {
      ...
      references: [{ title: 'NIST Special Publication 811: Guide for the Use of the International System of Units (SI)', citation: 'Thompson A, Taylor BN. NIST SP 811 (conventional mmHg / kPa)', year: 2008, url: 'https://www.nist.gov/pml/special-publication-811' }],
    },
  ...
  // ─── 14. Energy kcal ↔ kJ ──────────────────────────────────────────────────
  {
    ...
    evidence: {
      ...
      references: [{ title: 'Food energy — methods of analysis and conversion factors', citation: 'FAO Food and Nutrition Paper 77. Rome: FAO; 2003 (thermochemical calorie = 4.184 kJ)', year: 2003, url: 'https://www.fao.org/4/y5022e/y5022e04.htm' }],
    },
  ...
  // ─── 17. ARR and RRR ───────────────────────────────────────────────────────
  {
    ...
    evidence: {
      ...
      references: [
        {
          title: 'Users\' guides to the medical literature. II. How to use an article about therapy or prevention. B. What were the results and will they help me in caring for my patients?',
          citation: 'Guyatt GH, Sackett DL, Cook DJ. JAMA. 1994',
          year: 1994,
          pmid: '8258890',
      ...
      references: [
        {
          ...
          citation: 'Jaeschke R, Guyatt GH, Sackett DL. JAMA. 1994',
          year: 1994,
          pmid: '8309035',
      ...
      references: [
        {
          ...
          citation: 'Lwanga SK, Lemeshow S. Geneva: World Health Organization; 1991',
          year: 1991,
      ...
      references: [
        {
          ...
          citation: 'Wintrobe MM. Arch Intern Med. 1934',
          year: 1934,
        ...
        },
        {
          ...
          citation: 'Tefferi A, Hanson CA, Inwards DJ. Mayo Clin Proc. 2005',
          year: 2005,
          pmid: '16007898',
  ...
  // ─── 24. RDW + MCV pattern ─────────────────────────────────────────────────
  {
    ...
    inputs: [
      numberInput('mcv', 'MCV', { unit: 'fL', min: 40, max: 150, exampleValue: 75, helpText: 'Same teaching cutoffs as MCV classify: micro <80, normo 80–100, macro >100 fL.' }),
