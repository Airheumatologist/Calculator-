...
export const extraCalcs: Calculator[] = [
  {
    ...
    inputs: [
      ...
      yesNo('predisposing', 'Minor: Predisposing heart condition or IVDU'),
      yesNo('fever', 'Minor: Fever ≥38°C'),
      yesNo('vascular', 'Minor: Vascular phenomena (emboli, Janeway, etc.)'),
      yesNo('immuno', 'Minor: Immunologic phenomena (Osler, Roth, GN, RF)'),
      yesNo('microMinor', 'Minor: Microbiologic evidence not meeting major'),
    ],
    calculate(values) {
  ...
  },
  {
    ...
    inputs: [
      yesNo('strep', 'Evidence of preceding GAS infection (culture, rapid test, or rising ASO/anti-DNase B)'),
      yesNo('carditis', 'Major: Carditis'),
      yesNo('arthritis', 'Major: Arthritis (migratory polyarthritis)'),
      yesNo('chorea', 'Major: Chorea'),
      yesNo('erythema', 'Major: Erythema marginatum'),
      yesNo('nodules', 'Major: Subcutaneous nodules'),
      yesNo('arthralgia', 'Minor: Arthralgia'),
      yesNo('fever', 'Minor: Fever'),
      yesNo('elevatedAPR', 'Minor: Elevated ESR/CRP'),
      yesNo('prolongedPR', 'Minor: Prolonged PR interval'),
    ],
    calculate(values) {
  ...
  },
  {
    ...
    inputs: [
      ...
      yesNo('ankleEdema', 'Minor: Ankle edema'),
      yesNo('nightCough', 'Minor: Night cough'),
      yesNo('doe', 'Minor: Dyspnea on exertion'),
      yesNo('hepato', 'Minor: Hepatomegaly'),
      yesNo('pleural', 'Minor: Pleural effusion'),
      yesNo('hr120', 'Minor: Tachycardia >120'),
      yesNo('vc', 'Minor: Decrease in vital capacity by 1/3'),
    ],
    calculate(values) {
