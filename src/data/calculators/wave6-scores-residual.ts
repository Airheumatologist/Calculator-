...
export const wave6ScoresResidualCalcs: AuditedQuestionnaireCalculator[] = [
  // ─── 1. Oswestry Disability Index ──────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 0, 'Score this ODI section on its 0–5 statement scale (0 = least limitation, 5 = most). Choose the statement that best matches the patient today; skipped sections are dropped from the denominator.'),
      ...
      ], 0, 'Score this ODI section on its 0–5 statement scale (0 = least limitation, 5 = most). Dressing, washing and grooming all count for this section; skipped sections are dropped from the denominator.'),
      ...
      ], 0, 'Score this ODI section on its 0–5 statement scale (0 = least limitation, 5 = most). Judge the heaviest weight the patient lifts in daily life, not a maximal test; skipped sections are dropped.'),
      ...
      ], 0, 'Score this ODI section on its 0–5 statement scale (0 = least limitation, 5 = most). Base this on usual walking distance and aids used today; skipped sections are dropped from the denominator.'),
      ...
      ], 0, 'Score this ODI section on its 0–5 statement scale (0 = least limitation, 5 = most). Consider how long the patient can sit before pain forces a change; skipped sections are dropped.'),
      ...
      ], 0, 'Score this ODI section on its 0–5 statement scale (0 = least limitation, 5 = most). Consider how long the patient can stand before pain limits them; skipped sections are dropped.'),
      ...
      ], 0, 'Score this ODI section on its 0–5 statement scale (0 = least limitation, 5 = most). Score sleep disruption from back pain over the past week; skipped sections are dropped.'),
      ...
      ], 0, 'Score this ODI section on its 0–5 statement scale (0 = least limitation, 5 = most). Consider only how pain limits social activity; skipped sections are dropped from the denominator.'),
      ...
      ], 0, 'Score this ODI section on its 0–5 statement scale (0 = least limitation, 5 = most). Consider travel time tolerated despite pain; skipped sections are dropped from the denominator.'),
    ],
    calculate(values) {
      const items = [
        values.pain,
  ...
  // ─── 2. Neck Disability Index ──────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive 10-section NDI survey, or override with an existing NDI percentage. Only the selected mode\'s fields are used.'),
      selectInput('pain', 'Section 1: Pain Intensity', [
        { label: 'I have no pain at the moment', value: 0, points: 0 },
        { label: 'The pain is very mild at the moment', value: 1, points: 1 },
        { label: 'The pain is moderate at the moment', value: 2, points: 2 },
        ...
        { label: 'The pain is very severe at the moment', value: 4, points: 4 },
        { label: 'The pain is the worst imaginable at the moment', value: 5, points: 5 },
      ], 0, 'Score this NDI section on its 0–5 statement scale (0 = least limitation, 5 = most). Percent disability is normalized to the sections actually answered.'),
      selectInput('personalCare', 'Section 2: Personal Care (washing, dressing, etc.)', [
        { label: 'I can look after myself normally without causing extra pain', value: 0, points: 0 },
        ...
        { label: 'I need help every day in most aspects of self care', value: 4, points: 4 },
        { label: 'I do not get dressed, I wash with difficulty and stay in bed', value: 5, points: 5 },
      ], 0, 'Score this NDI section on its 0–5 statement scale (0 = least limitation, 5 = most). Washing, dressing and grooming all count; percent disability is normalized to the sections answered.'),
      selectInput('lifting', 'Section 3: Lifting', [
        { label: 'I can lift heavy weights without extra pain', value: 0, points: 0 },
        { label: 'I can lift heavy weights but it gives extra pain', value: 1, points: 1 },
        ...
        { label: 'I can only lift very light weights', value: 4, points: 4 },
        { label: 'I cannot lift or carry anything at all', value: 5, points: 5 },
      ], 0, 'Score this NDI section on its 0–5 statement scale (0 = least limitation, 5 = most). Judge lifting as it affects daily life, not a maximal effort test.'),
      ...
      ], 0, 'Score this NDI section on its 0–5 statement scale (0 = least limitation, 5 = most). Consider how long the patient can read before neck pain intrudes.'),
      ...
      ], 0, 'Score this NDI section on its 0–5 statement scale (0 = least limitation, 5 = most). Count headache frequency and intensity attributable to the neck problem.'),
      ...
      ], 0, 'Score this NDI section on its 0–5 statement scale (0 = least limitation, 5 = most). Consider difficulty concentrating caused by neck pain, not other causes.'),
      ...
      ], 0, 'Score this NDI section on its 0–5 statement scale (0 = least limitation, 5 = most). Includes usual job and housework; percent disability is normalized to the sections answered.'),
      ...
      ], 0, 'Score this NDI section on its 0–5 statement scale (0 = least limitation, 5 = most). Consider sleep disruption from neck pain over the past week.'),
      ...
      ], 0, 'Score this NDI section on its 0–5 statement scale (0 = least limitation, 5 = most). Includes hobbies, sport and social activity limited by neck pain.'),
  ...
  // ─── 3. DASH upper limb ────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive 30-item DASH survey, or override with an existing 0–100 score. Only the selected mode\'s fields are used.'),
      ...
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty/no symptoms, 5 = unable/extreme). DASH needs at least 27 of 30 items answered.'),
      selectInput('dash_q2', '2. Write', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Score what the patient can actually do, not what they avoid for other reasons.'),
      selectInput('dash_q3', '3. Turn a key', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Unanswered items are dropped, but at least 27 of 30 are required.'),
      selectInput('dash_q4', '4. Prepare a meal', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Consider the affected arm only when the activity can be done one-handed.'),
      selectInput('dash_q5', '5. Push open a heavy door', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Judged for the affected arm/shoulder/hand.'),
      selectInput('dash_q6', '6. Place an object on a shelf above your head', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Overhead reach with the affected limb is what is being graded.'),
      selectInput('dash_q7', '7. Do heavy household chores (e.g. wash walls, wash floors)', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Heavy chores means walls, floors and similar effort.'),
      selectInput('dash_q8', '8. Garden or do yard work', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Yard work includes mowing, raking and digging.'),
      selectInput('dash_q9', '9. Make a bed', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Making a bed includes lifting and tucking sheets.'),
      selectInput('dash_q10', '10. Carry a shopping bag or briefcase', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Carrying includes the weight of the bag or case.'),
      selectInput('dash_q11', '11. Carry a heavy object (over 10 lbs / 5 kg)', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Heavy is defined as more than about 10 lb (5 kg).'),
      selectInput('dash_q12', '12. Change a lightbulb overhead', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Overhead reach above shoulder height is the task being graded.'),
      selectInput('dash_q13', '13. Wash or blow dry your hair', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Includes both washing and blow-drying hair.'),
      selectInput('dash_q14', '14. Wash your back', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Washing the back requires shoulder range of motion.'),
      selectInput('dash_q15', '15. Put on a pullover sweater', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Dressing includes pulling a garment over the head.'),
      selectInput('dash_q16', '16. Use a knife to cut food', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Cutting food covers utensils held in the affected hand.'),
      selectInput('dash_q17', '17. Recreational activities requiring little effort (e.g. cards, knitting)', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Low-effort recreation includes cards, knitting and similar activity.'),
      selectInput('dash_q18', '18. Recreational activities with force or impact through arm (e.g. tennis, golf, hammer)', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). High-impact recreation includes tennis, golf and hammering.'),
      selectInput('dash_q19', '19. Recreational activities with free arm movement (e.g. swimming, frisbee)', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Free arm movement includes swimming or throwing a frisbee.'),
      selectInput('dash_q20', '20. Manage transportation needs (getting from one place to another)', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Getting from place to place includes driving or using transport.'),
      selectInput('dash_q21', '21. Sexual activities', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Sexual activity is graded only for limitation from the arm, shoulder or hand.'),
      ...
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = not at all, 5 = extremely). Rate interference with family and friend activities.'),
      selectInput('dash_q23', '23. Limited in your work or other regular daily activities', [
        ...
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = not limited at all, 5 = unable). Covers work and other regular daily activities.'),
      ...
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = none, 5 = extreme). Rate the worst pain in the arm, shoulder or hand.'),
      selectInput('dash_q25', '25. Arm, shoulder or hand pain when doing specific activity', [
        ...
        { label: '4 - Severe', value: 4 },
        { label: '5 - Extreme', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = none, 5 = extreme). Pain is graded during the specific activity that provokes it.'),
      selectInput('dash_q26', '26. Tingling (pins and needles) in your arm, shoulder or hand', [
        ...
        { label: '4 - Severe', value: 4 },
        { label: '5 - Extreme', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = none, 5 = extreme). Pins and needles in the affected limb only.'),
      selectInput('dash_q27', '27. Weakness in your arm, shoulder or hand', [
        ...
        { label: '4 - Severe', value: 4 },
        { label: '5 - Extreme', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = none, 5 = extreme). Weakness refers to perceived loss of strength in the limb.'),
      selectInput('dash_q28', '28. Stiffness in your arm, shoulder or hand', [
        ...
        { label: '4 - Severe', value: 4 },
        { label: '5 - Extreme', value: 5 },
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = none, 5 = extreme). Stiffness is graded in the affected arm, shoulder or hand.'),
      ...
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Sleep difficulty counts only when caused by limb pain.'),
      ...
      ], 1, 'Rate this DASH item for the past week on the 1–5 scale shown (1 = strongly disagree, 5 = strongly agree). Reflects confidence and usefulness rather than pain itself.'),
  ...
  // ─── 4. QuickDASH ──────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      selectInput('entryMode', 'Entry Mode', [
        ...
        { label: 'Direct score override (0–100)', value: 'direct' },
      ], 'survey', 'Choose the interactive 11-item QuickDASH survey, or override with an existing 0–100 score. Only the selected mode\'s fields are used.'),
      selectInput('qdash_q1', '1. Open a tight or new jar', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). At least 10 of 11 items must be answered.'),
      selectInput('qdash_q2', '2. Do heavy household chores (e.g. wash walls, floors)', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Heavy chores means walls, floors and similar effort.'),
      selectInput('qdash_q3', '3. Carry a shopping bag or briefcase', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Carrying includes the weight of the bag or case.'),
      selectInput('qdash_q4', '4. Wash your back', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Washing the back requires shoulder range of motion.'),
      selectInput('qdash_q5', '5. Use a knife to cut food', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Cutting food covers utensils held in the affected hand.'),
      selectInput('qdash_q6', '6. Heavy recreational activities with force or impact through arm (e.g. hammering, tennis)', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). High-impact recreation includes hammering or tennis.'),
      selectInput('qdash_q7', '7. Interference with normal social activities with family, friends, neighbors or groups', [
        ...
        { label: '4 - Quite a bit', value: 4 },
        { label: '5 - Extremely', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = not at all, 5 = extremely). Rate interference with social activities.'),
      selectInput('qdash_q8', '8. Limited in your work or other regular daily activities', [
        ...
        { label: '4 - Very limited', value: 4 },
        { label: '5 - Unable', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = not limited at all, 5 = unable). Covers work and other regular daily activities.'),
      selectInput('qdash_q9', '9. Arm, shoulder or hand pain', [
        ...
        { label: '4 - Severe', value: 4 },
        { label: '5 - Extreme', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = none, 5 = extreme). Rate the worst pain in the affected limb.'),
      selectInput('qdash_q10', '10. Tingling (pins and needles) in your arm, shoulder or hand', [
        ...
        { label: '4 - Severe', value: 4 },
        { label: '5 - Extreme', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = none, 5 = extreme). Pins and needles in the affected limb only.'),
      selectInput('qdash_q11', '11. Difficulty sleeping because of pain in arm, shoulder or hand', [
        ...
        { label: '4 - Severe difficulty', value: 4 },
        { label: '5 - So much difficulty that I cannot sleep', value: 5 },
      ], 1, 'Rate this QuickDASH item for the past week on the 1–5 scale shown (1 = no difficulty, 5 = unable). Sleep difficulty counts only when caused by limb pain.'),
  ...
  // ─── 5. WOMAC ──────────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive 24-item WOMAC, or override with existing subscale or total scores. Survey answers are used only in interactive mode.'),
      // Pain (5 items)
      ...
      ], 1, 'Rate this WOMAC pain item for the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Pain items sum to 0–20.'),
      selectInput('w_p2', 'Pain: Going up or down stairs', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 2, 'Rate this WOMAC pain item for the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Stairs are graded in either direction.'),
      selectInput('w_p3', 'Pain: At night while in bed', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate this WOMAC pain item for the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Night pain includes pain that wakes the patient.'),
      selectInput('w_p4', 'Pain: Sitting or lying down', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate this WOMAC pain item for the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Grade pain while sitting or lying, not stiffness.'),
      selectInput('w_p5', 'Pain: Standing upright', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 2, 'Rate this WOMAC pain item for the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Grade pain while standing upright.'),
      // Stiffness (2 items)
      selectInput('w_s1', 'Stiffness: How severe is stiffness after first awakening in the morning?', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate stiffness for the last 48 hours on the 0–4 scale shown (0 = none, 4 = extreme). Morning stiffness is graded after first awakening.'),
      selectInput('w_s2', 'Stiffness: How severe is stiffness after sitting, lying or resting later in the day?', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate stiffness for the last 48 hours on the 0–4 scale shown (0 = none, 4 = extreme). Later-day stiffness is graded after sitting, lying or resting.'),
      // Function (17 items)
      selectInput('w_f1', 'Function: Descending stairs', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 2, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Function items sum to 0–68.'),
      selectInput('w_f2', 'Function: Ascending stairs', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 2, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Consider the affected knee.'),
      selectInput('w_f3', 'Function: Rising from sitting', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 2, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Rising from sitting is graded without arm support.'),
      selectInput('w_f4', 'Function: Standing', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Standing is graded as tolerated, not timed.'),
      selectInput('w_f5', 'Function: Bending to floor / pick up an object', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 2, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Bending to the floor includes picking up an object.'),
      selectInput('w_f6', 'Function: Walking on flat ground', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Flat ground walking, not stairs.'),
      selectInput('w_f7', 'Function: Getting in or out of a car', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 2, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Entering or leaving a car is graded as one item.'),
      selectInput('w_f8', 'Function: Going shopping', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 2, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Shopping includes walking and carrying.'),
      selectInput('w_f9', 'Function: Putting on socks / stockings', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Putting on socks or stockings is graded as one item.'),
      selectInput('w_f10', 'Function: Rising from bed', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Rising from bed is graded without arm support.'),
      selectInput('w_f11', 'Function: Taking off socks / stockings', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Taking off socks or stockings is graded as one item.'),
      selectInput('w_f12', 'Function: Lying in bed', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Lying in bed is graded for knee-related limitation.'),
      selectInput('w_f13', 'Function: Getting in or out of bath', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 2, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Getting in or out of the bath is graded as one item.'),
      selectInput('w_f14', 'Function: Sitting', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Sitting is graded for the affected knee.'),
      selectInput('w_f15', 'Function: Getting on or off toilet', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Getting on or off the toilet is graded as one item.'),
      selectInput('w_f16', 'Function: Heavy domestic duties (e.g. moving heavy boxes, scrub floors)', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 3, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Heavy duties includes moving boxes and scrubbing floors.'),
      selectInput('w_f17', 'Function: Light domestic duties (e.g. cooking, dusting)', [
        ...
        { label: '3 - Severe', value: 3 },
        { label: '4 - Extreme', value: 4 },
      ], 1, 'Rate how much difficulty this activity caused in the last 48 hours: 0 = none, 1 = mild, 2 = moderate, 3 = severe, 4 = extreme. Light duties includes cooking and dusting.'),
      ...
      numberInput('pain', 'Pain subscale override (optional, 0–20)', { helpText: 'Optional override for the WOMAC pain subscale (0–20). Use it only with direct entry; it is ignored in interactive survey mode.',
        min: 0,
        max: 20,
        step: 1,
        exampleValue: 8,
      ...
      numberInput('function', 'Function subscale override (optional, 0–68)', { helpText: 'Optional override for the WOMAC function subscale (0–68). Use it only with direct entry; it is ignored in interactive survey mode.',
        min: 0,
        max: 68,
        step: 1,
        exampleValue: 28,
  ...
  // ─── 6. IKDC ───────────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive IKDC questionnaire, or override with an existing transformed 0–100 score. Only the selected mode\'s fields are used.'),
      ...
      ], 3, 'Highest activity level possible without significant knee pain: 4 = very strenuous, 3 = strenuous, 2 = moderate, 1 = light, 0 = unable. Higher is better.'),
      ...
      ], 3, 'Stiffness or swelling over the past 4 weeks or since injury: 4 = not at all, 3 = mildly, 2 = moderately, 1 = very, 0 = extremely. Higher is better.'),
      ...
      ], 3, 'Highest activity level without significant knee swelling: 4 = very strenuous, 3 = strenuous, 2 = moderate, 1 = light, 0 = unable. Higher is better.'),
      selectInput('ikdc_q6', '6. Does your knee lock or catch?', [
        { label: '1 - No', value: 1 },
        { label: '0 - Yes', value: 0 },
      ], 1, 'Whether the knee locks or catches: 1 = no, 0 = yes. This is the only two-option IKDC item and higher is better.'),
      ...
      ], 3, 'Highest activity level without the knee giving way: 4 = very strenuous, 3 = strenuous, 2 = moderate, 1 = light, 0 = unable. Higher is better.'),
      selectInput('ikdc_q8', '8. Highest level of activity you can participate in on a regular basis', [
        ...
        { label: '1 - Light activities (walking, housework)', value: 1 },
        { label: '0 - Unable due to swelling', value: 0 },
      ], 3, 'Highest activity level the patient can sustain regularly: 4 = very strenuous, 3 = strenuous, 2 = moderate, 1 = light, 0 = unable. Higher is better.'),
      ...
      ], 3, 'Rate how difficult this task is: 4 = not difficult at all, 3 = minimally, 2 = moderately, 1 = extremely difficult, 0 = unable. Higher is better.'),
      selectInput('ikdc_q9b', '9b. Go down stairs', [
        ...
        { label: '1 - Extremely difficult', value: 1 },
        { label: '0 - Unable to do', value: 0 },
      ], 3, 'Rate how difficult this task is: 4 = not difficult at all, 3 = minimally, 2 = moderately, 1 = extremely difficult, 0 = unable. Score the affected knee.'),
      selectInput('ikdc_q9c', '9c. Kneel on front of your knee', [
        ...
        { label: '1 - Extremely difficult', value: 1 },
        { label: '0 - Unable to do', value: 0 },
      ], 2, 'Rate how difficult this task is: 4 = not difficult at all, 3 = minimally, 2 = moderately, 1 = extremely difficult, 0 = unable. Kneeling is graded on the front of the knee.'),
      selectInput('ikdc_q9d', '9d. Squat', [
        ...
        { label: '1 - Extremely difficult', value: 1 },
        { label: '0 - Unable to do', value: 0 },
      ], 2, 'Rate how difficult this task is: 4 = not difficult at all, 3 = minimally, 2 = moderately, 1 = extremely difficult, 0 = unable. Squatting includes getting down and back up.'),
      selectInput('ikdc_q9e', '9e. Sit with knee bent', [
        ...
        { label: '1 - Extremely difficult', value: 1 },
        { label: '0 - Unable to do', value: 0 },
      ], 3, 'Rate how difficult this task is: 4 = not difficult at all, 3 = minimally, 2 = moderately, 1 = extremely difficult, 0 = unable. Sitting with the knee bent is graded as stated.'),
  ...
  // ─── 7. EASI eczema ────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive regional EASI assessment, or override with an existing EASI 0–72 total. The age band sets region multipliers.'),
      ...
      ], 2, 'Area involvement for this region: 0 = 0%, 1 = 1–9%, 2 = 10–29%, 3 = 30–49%, 4 = 50–69%, 5 = 70–89%, 6 = 90–100%.'),
      selectInput('head_erythema', 'Head & Neck: Erythema (redness)', [
        { label: '0 - None', value: 0 },
        { label: '1 - Mild', value: 1 },
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Severity of this sign in the region: 0 = none, 1 = mild, 2 = moderate, 3 = severe. The four signs are scored separately for each region.'),
      selectInput('head_induration', 'Head & Neck: Induration / Papulation (thickness/swelling)', [
        { label: '0 - None', value: 0 },
        { label: '1 - Mild', value: 1 },
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Severity of this sign in the region: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Induration/papulation is the thickness or swelling of lesions.'),
      selectInput('head_excoriation', 'Head & Neck: Excoriation (scratch marks)', [
        { label: '0 - None', value: 0 },
        { label: '1 - Mild', value: 1 },
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Severity of this sign in the region: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Excoriation means scratch marks.'),
      selectInput('head_lichenification', 'Head & Neck: Lichenification (skin thickening/lining)', [
        { label: '0 - None', value: 0 },
        { label: '1 - Mild', value: 1 },
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 0, 'Severity of this sign in the region: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Lichenification is skin thickening with accentuated markings.'),
      // Upper limbs (0.2)
      ...
      selectInput('ul_erythema', 'Upper Limbs: Erythema', [
        ...
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Severity of this sign in the region: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Score the average severity across the region.'),
      ...
      selectInput('ul_lichenification', 'Upper Limbs: Lichenification', [
        ...
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Severity of this sign in the region: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Lichenification is skin thickening with accentuated markings.'),
      // Trunk (0.3)
  ...
  // ─── 8. SCORAD eczema ──────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive SCORAD components, or override with an existing 0–103 total. Extent, intensity and subjective items feed the same formula.'),
      ...
      selectInput('int_erythema', 'Part B: Erythema (redness)', [
        ...
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Intensity of this sign at a representative lesion: 0 = none, 1 = mild, 2 = moderate, 3 = severe. The six intensity items sum to 0–18.'),
      selectInput('int_edema', 'Part B: Edema / Papulation (swelling)', [
        { label: '0 - None', value: 0 },
        { label: '1 - Mild', value: 1 },
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Intensity of this sign at a representative lesion: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Edema/papulation is swelling or thickening of lesions.'),
      selectInput('int_oozing', 'Part B: Oozing / Crusting', [
        { label: '0 - None', value: 0 },
        { label: '1 - Mild', value: 1 },
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Intensity of this sign at a representative lesion: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Oozing/crusting is graded as one item.'),
      selectInput('int_excoriation', 'Part B: Excoriation (scratch marks)', [
        { label: '0 - None', value: 0 },
        { label: '1 - Mild', value: 1 },
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Intensity of this sign at a representative lesion: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Excoriation means scratch marks.'),
      selectInput('int_lichenification', 'Part B: Lichenification (skin thickening)', [
        { label: '0 - None', value: 0 },
        { label: '1 - Mild', value: 1 },
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Intensity of this sign at a representative lesion: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Lichenification is skin thickening with accentuated markings.'),
      selectInput('int_dryness', 'Part B: Dryness / Xerosis (non-lesional skin)', [
        { label: '0 - None', value: 0 },
        { label: '1 - Mild', value: 1 },
        { label: '2 - Moderate', value: 2 },
        { label: '3 - Severe', value: 3 },
      ], 1, 'Intensity of this sign at a representative lesion: 0 = none, 1 = mild, 2 = moderate, 3 = severe. Dryness is judged on non-lesional skin.'),
  ...
  // ─── 10. Snellen to LogMAR ─────────────────────────────────────────────────
  {
    ...
    inputs: [
      selectInput(
        ...
        'fraction'
      , 'Pick the visual-acuity notation you have on file; the tool converts between Snellen fraction, decimal acuity and logMAR.'),
  ...
  // ─── 11. VHI-10 ────────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive 10-item VHI-10, or override with an existing total (0–40). Only the selected mode\'s fields are used.'),
      ...
      ], 1, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. The 10 items sum to 0–40, higher = worse.'),
      selectInput('vhi_q2', '2. People have difficulty understanding me in a noisy room', [
        ...
        { label: '3 - Almost always', value: 3 },
        { label: '4 - Always', value: 4 },
      ], 2, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. Answered for noisy-room understanding.'),
      selectInput('vhi_q3', '3. My voice difficulties restrict my personal and social life', [
        ...
        { label: '3 - Almost always', value: 3 },
        { label: '4 - Always', value: 4 },
      ], 1, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. Covers restriction of personal and social life.'),
      selectInput('vhi_q4', '4. I feel left out of conversations because of my voice', [
        ...
        { label: '3 - Almost always', value: 3 },
        { label: '4 - Always', value: 4 },
      ], 1, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. Reflects feeling excluded from conversations.'),
      selectInput('vhi_q5', '5. My voice problem causes me to lose income', [
        ...
        { label: '3 - Almost always', value: 3 },
        { label: '4 - Always', value: 4 },
      ], 0, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. Score only voice-related loss of income.'),
      selectInput('vhi_q6', '6. I feel as though I have to strain to produce voice', [
        ...
        { label: '3 - Almost always', value: 3 },
        { label: '4 - Always', value: 4 },
      ], 2, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. Reflects effort or strain needed to phonate.'),
      selectInput('vhi_q7', '7. The clarity of my voice is unpredictable', [
        ...
        { label: '3 - Almost always', value: 3 },
        { label: '4 - Always', value: 4 },
      ], 2, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. Addresses day-to-day voice consistency.'),
      selectInput('vhi_q8', '8. My voice problem upsets me', [
        ...
        { label: '3 - Almost always', value: 3 },
        { label: '4 - Always', value: 4 },
      ], 1, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. Emotional distress from the voice problem.'),
      selectInput('vhi_q9', '9. My voice makes me feel handicapped', [
        ...
        { label: '3 - Almost always', value: 3 },
        { label: '4 - Always', value: 4 },
      ], 1, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. Handicap is judged by the patient, not the examiner.'),
      selectInput('vhi_q10', '10. People ask, "What is wrong with your voice?"', [
        ...
        { label: '3 - Almost always', value: 3 },
        { label: '4 - Always', value: 4 },
      ], 1, 'How often this applies: 0 = never, 1 = almost never, 2 = sometimes, 3 = almost always, 4 = always. Counts how often others notice the voice problem.'),
  ...
  // ─── 12. Pure-tone average ─────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      numberInput('f1000', '1000 Hz threshold', { helpText: 'Air-conduction threshold at 1000 Hz in dB HL from the audiogram (not bone conduction). Adults hear normally at 25 dB HL or better.', unit: 'dB HL', min: -10, max: 120, step: 5, exampleValue: 25 }),
      numberInput('f2000', '2000 Hz threshold', { helpText: 'Air-conduction threshold at 2000 Hz in dB HL from the same audiogram used for the other frequencies. Thresholds below 25 dB HL are normal.', unit: 'dB HL', min: -10, max: 120, step: 5, exampleValue: 30 }),
  ...
  // ─── 13. Berlin Questionnaire ──────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], undefined, 'Category 1 snoring loudness: snoring louder than talking, or loud enough to be heard in the next room, counts as a positive response.'),
      ...
      ], undefined, 'Category 1 snoring frequency: snoring at least 3–4 times per week counts as a positive response for the sleep-apnea screen.'),
      selectInput('bothers', 'Has snoring bothered others?', [
        { label: 'No (0)', value: 0 },
        { label: 'Yes (1)', value: 1 },
      ], undefined, 'Category 1: whether snoring bothers other people often or nearly every day completes the snoring-risk score.'),
      ...
      selectInput('tiredDay', 'Tired/fatigued during wake time?', [
        ...
        { label: '3–4×/week (1)', value: 'weekly-3-4' },
        { label: 'Nearly every day (1)', value: 'daily' },
      ], undefined, 'Category 2 daytime sleepiness: tiredness or fatigue at least 3–4 times per week counts as a positive response.'),
  ...
  // ─── 14. CAT COPD ──────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive 8-item CAT, or override with an existing 0–40 total. Survey mode requires all eight items.'),
      ...
      ], 2, 'Score this CAT item 0–5 from the option wording (0 = no problem, 5 = the worst stated). The eight items sum to 0–40.'),
      ...
      ], 2, 'Score this CAT item 0–5 from the option wording (0 = no problem, 5 = the worst stated). Phlegm means mucus in the chest, not post-nasal drip alone.'),
      ...
      ], 1, 'Score this CAT item 0–5 from the option wording (0 = no problem, 5 = the worst stated). Chest tightness is graded as the patient experiences it.'),
      ...
      ], 3, 'Score this CAT item 0–5 from the option wording (0 = no problem, 5 = the worst stated). The anchor activity is a hill or one flight of stairs.'),
      ...
      ], 2, 'Score this CAT item 0–5 from the option wording (0 = no problem, 5 = the worst stated). Activity limitation at home only.'),
      ...
      ], 2, 'Score this CAT item 0–5 from the option wording (0 = no problem, 5 = the worst stated). Confidence about leaving home despite the lung condition.'),
      ...
      ], 2, 'Score this CAT item 0–5 from the option wording (0 = no problem, 5 = the worst stated). Sleep quality attributable to the lung condition.'),
      ...
      ], 2, 'Score this CAT item 0–5 from the option wording (0 = no problem, 5 = the worst stated). Energy reflects the past few weeks of COPD impact.'),
  ...
  // ─── 17. ACT asthma ────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive 5-item ACT, or override with an existing 5–25 total. Survey mode requires all five items.'),
      ...
      ], 4, 'Each ACT item is scored 1–5 with 5 = best control. The five items sum to 5–25; 19 or less indicates uncontrolled asthma.'),
      ...
      ], 4, 'Each ACT item is scored 1–5 with 5 = best control. Shortness of breath is recalled over the past 4 weeks.'),
      selectInput('act_q3', '3. During the past 4 weeks, how often did your asthma symptoms wake you up at night or earlier than usual?', [
        ...
        { label: '5 - Not at all', value: 5 },
      ], 4, 'Each ACT item is scored 1–5 with 5 = best control. Night or early-morning waking from asthma over the past 4 weeks.'),
      selectInput('act_q4', '4. During the past 4 weeks, how often have you used your rescue inhaler or nebulizer medication (such as albuterol)?', [
        ...
        { label: '5 - Not at all', value: 5 },
      ], 4, 'Each ACT item is scored 1–5 with 5 = best control. Rescue inhaler or nebulizer use over the past 4 weeks.'),
      ...
      ], 4, 'Each ACT item is scored 1–5 with 5 = best control. The final item is the patient\'s own rating of asthma control.'),
  ...
  // ─── 18. ACQ asthma ────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive ACQ, or override with an existing mean score (0–6). Survey mode uses the items appropriate to the selected version.'),
      ...
      ], '5', 'Select the 7-item ACQ (includes pre-bronchodilator FEV1% predicted) or the 6-item symptom-only version. The result is the mean of the items answered.'),
      // Items 1-5 (Symptoms)
      ...
      ], 1, 'Score this ACQ item 0–6 (0 = no impairment, 6 = maximum). The reported ACQ value is the mean of the answered items.'),
      ...
      ], 1, 'Score this ACQ item 0–6 (0 = no impairment, 6 = maximum). Morning symptoms are recalled over the past week.'),
      ...
      ], 1, 'Score this ACQ item 0–6 (0 = no impairment, 6 = maximum). Activity limitation is recalled over the past week.'),
      ...
      ], 1, 'Score this ACQ item 0–6 (0 = no impairment, 6 = maximum). Breathlessness is recalled over the past week.'),
      ...
      ], 1, 'Score this ACQ item 0–6 (0 = no impairment, 6 = maximum). Wheeze frequency is recalled over the past week.'),
  ...
  // ─── 20. Elixhauser simplified ─────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      yesNo('valve', 'Valvular disease', 1, 'Count when the chart documents valvular disease (e.g. aortic, mitral or other valve disease), including prosthesis; count once regardless of severity.'),
      ...
      yesNo('pvd', 'Peripheral vascular disease', 1, 'Count when the chart documents peripheral vascular disease from atherosclerosis or arterial insufficiency, including claudication.'),
      yesNo('htn', 'Hypertension (uncomplicated or complicated)', 1, 'Count when the chart documents hypertension, treated or untreated. Uncomplicated and complicated hypertension both count once.'),
      ...
      yesNo('cpd', 'Chronic pulmonary disease', 1, 'Count when the chart documents chronic pulmonary disease such as COPD, asthma or chronic respiratory failure.'),
      yesNo('dm', 'Diabetes (uncomplicated or complicated)', 1, 'Count when the chart documents diabetes, with or without chronic complications; both count once in the simplified index.'),
      yesNo('hypothyroid', 'Hypothyroidism', 1, 'Count when the chart documents hypothyroidism, including disease controlled on replacement therapy.'),
      yesNo('renal', 'Renal failure', 1, 'Chronic renal failure / CKD with renal insufficiency — not isolated mild Cr bump.'),
      yesNo('liver', 'Liver disease', 1, 'Count when the chart documents liver disease such as cirrhosis, chronic hepatitis or hepatic failure; count once even if decompensated.'),
      yesNo('ulcer', 'Peptic ulcer disease excluding bleeding', 1, 'Count when the chart documents peptic ulcer disease; bleeding ulcers are captured by the anemia flag, not counted a second time here.'),
      yesNo('aids', 'AIDS/HIV', 1, 'Count when the chart documents AIDS or symptomatic HIV disease rather than asymptomatic HIV infection.'),
      yesNo('lymphoma', 'Lymphoma', 1, 'Count when the chart documents Hodgkin or non-Hodgkin lymphoma, including disease in remission after treatment.'),
      yesNo('cancerMet', 'Metastatic cancer', 1, 'Count when the chart documents metastatic cancer. Do not also flag the primary solid tumor separately in the simplified index.'),
      yesNo('cancerSolid', 'Solid tumor without metastasis', 1, 'Count when the chart documents a solid tumor without metastasis, including treated primaries. Metastatic disease is flagged as metastatic cancer instead.'),
      yesNo('rheum', 'Rheumatoid arthritis / collagen vascular', 1, 'Count when the chart documents rheumatoid arthritis or another collagen vascular / connective tissue disease such as lupus, scleroderma or vasculitis.'),
      ...
      yesNo('anemia', 'Deficiency / blood loss anemia', 1, 'Count when the chart documents a deficiency anemia or chronic blood-loss anemia, including iron and B12 deficiency.'),
      yesNo('alcohol', 'Alcohol abuse', 1, 'Count when the chart documents alcohol abuse or dependence; do not infer the flag from reported intake alone.'),
      yesNo('drugs', 'Drug abuse', 1, 'Count when the chart documents drug abuse or dependence involving prescribed or illicit substances; a documented diagnosis is required.'),
      yesNo('psychoses', 'Psychoses', 1, 'Count when the chart documents a psychotic disorder such as schizophrenia, schizoaffective disorder or other psychosis.'),
      yesNo('depression', 'Depression', 1, 'Count when the chart documents a depressive disorder such as major depression or dysthymia, treated or untreated.'),
    ],
    calculate(values) {
      const keys = [
        'chf',
  ...
  // ─── 22. Fried frailty phenotype ───────────────────────────────────────────
  {
    ...
    inputs: [
      yesNo('weightLoss', 'Unintentional weight loss (≥10 lb / ≥4.5 kg in past year)', 1, 'Positive for unintentional loss of at least 10 lb (4.5 kg) or 5% of body weight in the past year. Intentional weight loss from dieting does not count.'),
  ...
  // ─── 23. Morse Fall Scale ──────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], undefined, 'Scores 15 points when the chart lists two or more medical diagnoses in addition to the admitting diagnosis.'),
      ...
      ], undefined, 'Scores 20 points for any intravenous line, heparin lock or other IV access in place at assessment.'),
  ...
  // ─── 24. Hendrich II Fall Risk ─────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      yesNo('male', 'Male sex', 1, 'Male sex adds 1 point in the Hendrich II Fall Risk Model.'),
  ...
  // ─── 25. MNA-SF ────────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      ], 'survey', 'Choose the interactive 6-item MNA-SF, or override with an existing 0–14 total. Item F accepts BMI or calf circumference.'),
      ...
      ], 2, 'Food-intake decline over the past 3 months from appetite loss, digestive problems or chewing/swallowing difficulty: 0 = severe, 1 = moderate, 2 = no decline.'),
      ...
      ], 3, 'Involuntary weight loss in the last 3 months: 0 = over 3 kg, 1 = does not know, 2 = 1–3 kg, 3 = no weight loss. The unknown option triggers the BMI item.'),
      ...
      ], 2, 'Mobility: 0 = bed or chair bound, 1 = able to get up but does not go out, 2 = goes out independently.'),
      selectInput('mna_d', 'D. Has suffered psychological stress or acute disease in the past 3 months?', [
        { label: '0 - Yes', value: 0 },
        { label: '2 - No', value: 2 },
      ], 2, 'Psychological stress or acute disease in the past 3 months: 0 = yes, 2 = no.'),
      ...
      ], 2, 'Neuropsychological problems: 0 = severe dementia or depression, 1 = mild dementia, 2 = no problems.'),
