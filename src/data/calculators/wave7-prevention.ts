...

  {
    ...
    inputs: [
      ...
      numberInput('totalChol', 'Total cholesterol', {
        ...
        step: 0.1,
        exampleValue: 5.5,
        helpText: 'Enter the reported value and pick its unit (mmol/L or mg/dL) — the app converts to the mmol/L the equation uses. This is the total-cholesterol term in the published equation.',
      }),
...

  {
    ...
    inputs: [
      ...
      numberInput('nonhdl', 'Non-HDL cholesterol', {
        ...
        step: 0.1,
        exampleValue: 4,
        helpText: 'Total cholesterol − HDL. Enter the reported value and pick its unit (mmol/L or mg/dL) — the app converts.',
      }),
