...
export const wave7HighuseCalcs: Calculator[] = [
  // ─── 1. Seattle Heart Failure Model (educational) ──────────────────────────
  {
    ...
    inputs: [
      numberInput('age', 'Age', { unit: 'years', min: 18, max: 100, exampleValue: 65 }),
      selectInput(
        'sex',
        'Sex',
        [
      ...
      numberInput('lvef', 'LVEF', { unit: '%', min: 8, max: 70, exampleValue: 30 }),
      yesNo('ischemic', 'Ischemic etiology', null),
      numberInput('sbp', 'Systolic BP', { unit: 'mmHg', min: 70, max: 200, exampleValue: 110 }),
      ...
      numberInput('weightKg', 'Weight', { unit: 'kg', unitKind: 'weight', min: 30, max: 200, step: 0.5, exampleValue: 80 }),
      numberInput('sodium', 'Serum sodium', { unit: 'mEq/L', min: 115, max: 150, exampleValue: 138 }),
      numberInput('hemoglobin', 'Hemoglobin', { unit: 'g/dL', min: 7, max: 18, step: 0.1, exampleValue: 13 }),
      numberInput('lymphocytes', 'Lymphocytes', { unit: '%', min: 5, max: 60, exampleValue: 25 }),
      numberInput('uricAcid', 'Uric acid', { unit: 'mg/dL', min: 2, max: 16, step: 0.1, exampleValue: 7 }),
      numberInput('cholesterol', 'Total cholesterol', { unit: 'mg/dL', min: 80, max: 350, exampleValue: 180 }),
  ...
  // ─── 2. MAGGIC HF risk ─────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      numberInput('lvef', 'LVEF', { unit: '%', min: 10, max: 70, exampleValue: 50 }),
      numberInput('sbp', 'Systolic BP', { unit: 'mmHg', min: 80, max: 200, exampleValue: 150 }),
      numberInput('bmi', 'BMI', { unit: 'kg/m²', min: 12, max: 50, step: 0.1, exampleValue: 32 }),
  ...
  // ─── 5. PRISM III ──────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      numberInput('sbp', 'Lowest systolic BP', { unit: 'mmHg', min: 30, max: 180, exampleValue: 100 }),
      numberInput('hr', 'Highest heart rate', { unit: '/min', min: 40, max: 250, exampleValue: 120 }),
      numberInput('temp', 'Temperature (most abnormal)', { unit: '°C', min: 32, max: 41.5, step: 0.1, exampleValue: 37 }),
      numberInput('gcs', 'GCS (worst; not post-sedation)', { min: 3, max: 15, exampleValue: 15 }),
      ...
      numberInput('ph', 'pH (most abnormal)', { min: 6.8, max: 7.7, step: 0.01, exampleValue: 7.4 }),
      numberInput('pco2', 'Highest PCO2', { unit: 'mmHg', min: 20, max: 100, exampleValue: 40 }),
      numberInput('pao2', 'Lowest PaO2', { unit: 'mmHg', min: 30, max: 150, exampleValue: 90 }),
      numberInput('tco2', 'Total CO2 (most abnormal)', { unit: 'mmol/L', min: 3, max: 45, exampleValue: 24 }),
      numberInput('glucose', 'Highest glucose', { unit: 'mg/dL', min: 40, max: 500, exampleValue: 100 }),
      numberInput('potassium', 'Highest potassium', { unit: 'mEq/L', min: 2.2, max: 9, step: 0.1, exampleValue: 4 }),
      numberInput('creatinine', 'Highest creatinine', { unit: 'mg/dL', unitKind: 'creatinine', min: 0.1, max: 8, step: 0.1, exampleValue: 0.4 }),
      numberInput('bun', 'Highest BUN', { unit: 'mg/dL', min: 2, max: 80, exampleValue: 10 }),
      numberInput('wbc', 'Lowest WBC', { unit: '×10³/µL', min: 0.5, max: 40, step: 0.1, exampleValue: 8 }),
      numberInput('pt', 'Highest PT', { unit: 's', min: 10, max: 60, exampleValue: 12 }),
      numberInput('ptt', 'Highest PTT', { unit: 's', min: 20, max: 150, exampleValue: 32 }),
      numberInput('platelets', 'Lowest platelets', { unit: '×10³/µL', min: 10, max: 450, exampleValue: 250 }),
    ],
    calculate(values) {
  ...
  // ─── 6. PRISM IV ───────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      numberInput('sbp', 'Lowest systolic BP (first 4 h)', { unit: 'mmHg', min: 30, max: 180, exampleValue: 100 }),
      numberInput('hr', 'Highest heart rate (first 4 h)', { unit: '/min', min: 40, max: 250, exampleValue: 120 }),
      ...
      numberInput('ph', 'Most abnormal pH', { min: 6.8, max: 7.7, step: 0.01, exampleValue: 7.4 }),
      numberInput('pco2', 'Highest PCO2', { unit: 'mmHg', min: 20, max: 100, exampleValue: 40 }),
      numberInput('creatinine', 'Highest creatinine', { unit: 'mg/dL', unitKind: 'creatinine', min: 0.1, max: 8, step: 0.1, exampleValue: 0.4 }),
      numberInput('wbc', 'Lowest WBC', { unit: '×10³/µL', min: 0.5, max: 40, step: 0.1, exampleValue: 8 }),
      numberInput('platelets', 'Lowest platelets', { unit: '×10³/µL', min: 10, max: 450, exampleValue: 250 }),
  ...
  // ─── 11. NHS PREDICT breast (educational) ──────────────────────────────────
  {
    ...
    inputs: [
      numberInput('age', 'Age at diagnosis', { unit: 'years', min: 25, max: 90, exampleValue: 55 }),
      numberInput('sizeMm', 'Tumor size', { unit: 'mm', min: 1, max: 150, exampleValue: 20 }),
      ...
      numberInput('nodes', 'Positive axillary nodes', { min: 0, max: 30, exampleValue: 0 }),
  ...
  // ─── 13. ACEF II ───────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      numberInput('age', 'Age', { unit: 'years', min: 18, max: 100, exampleValue: 70 }),
      numberInput('ef', 'LVEF', { unit: '%', min: 10, max: 80, exampleValue: 50 }),
  ...
  // ─── 14. SYNTAX II ─────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      numberInput('crcl', 'Creatinine clearance', { unit: 'mL/min', min: 15, max: 150, exampleValue: 80 }),
      numberInput('lvef', 'LVEF', { unit: '%', min: 15, max: 70, exampleValue: 55 }),
