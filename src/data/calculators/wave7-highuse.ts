...
export const wave7HighuseCalcs: Calculator[] = [
  ...
  // ─── 2. MAGGIC HF risk ─────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      selectInput('nyha', 'NYHA class', [
        ...
        { label: 'II', value: 2, points: 2 },
        { label: 'III', value: 3, points: 6 },
        { label: 'IV', value: 4, points: 8 },
      ]),
  ...
  // ─── 3. T-MACS ─────────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      yesNo('ecgIschemia', 'Acute ECG ischemia', null),
    ...
    evidence: {
      ...
      references: [
        {
          title: 'Troponin-only Manchester Acute Coronary Syndromes (T-MACS) decision aid',
          citation: 'Body R et al. Emerg Med J. 2017',
          year: 2017,
          pmid: '27164947',
  ...
  // ─── 4. GLIM malnutrition ──────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      numberInput('bmi', 'BMI', { unit: 'kg/m²', min: 10, max: 50, step: 0.1, defaultValue: 24 }),
      selectInput('weightLoss', 'Unintentional weight loss', [
        { label: 'None / below GLIM threshold', value: 'none' },
        { label: 'Moderate (>5% in 6 months or >10% beyond 6 months)', value: 'moderate' },
        { label: 'Severe (>10% in 6 months or >20% beyond 6 months)', value: 'severe' },
      ]),
  ...
  // ─── 5. PRISM III ──────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      selectInput('pupils', 'Pupillary reflexes', [
        { label: 'Both reactive', value: 0, points: 0 },
        { label: 'One fixed (>3 mm)', value: 7, points: 7 },
        { label: 'Both fixed (>3 mm)', value: 11, points: 11 },
      ]),
  ...
  // ─── 6. PRISM IV ───────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      numberInput('ageMonths', 'Age', { unit: 'months', min: 0, max: 216, defaultValue: 36 }),
      selectInput(
        'source',
        'Admission source',
        [
      ...
      numberInput('gcs', 'Worst GCS (first 4 h)', { min: 3, max: 15, defaultValue: 15 }),
      selectInput('pupils', 'Pupillary reflexes', [
        { label: 'Both reactive', value: 'none' },
        { label: 'One fixed', value: 'one' },
        { label: 'Both fixed', value: 'both' },
      ]),
      ...
      references: [
        {
          ...
          year: 2016,
          pmid: '26492059',
          doi: '10.1097/PCC.0000000000000553',
        },
      ],
    },
    nextSteps: [
  ...
  // ─── 7. PRAM ───────────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      selectInput('retractions', 'Suprasternal retractions', [
        ...
        { label: 'Present', value: 2, points: 2 },
      ]),
      ...
      selectInput('airEntry', 'Air entry', [
        ...
        { label: 'Decreased at bases', value: 1, points: 1 },
        { label: 'Widespread decrease', value: 2, points: 2 },
        { label: 'Absent / minimal', value: 3, points: 3 },
      ]),
      selectInput('wheeze', 'Wheezing', [
        { label: 'None', value: 0, points: 0 },
        { label: 'Expiratory only', value: 1, points: 1 },
        { label: 'Inspiratory and expiratory', value: 2, points: 2 },
        { label: 'Audible without stethoscope or silent chest with minimal air entry', value: 3, points: 3 },
      ]),
    ...
    evidence: {
      ...
      references: [
        {
          title: 'The Pediatric Respiratory Assessment Measure: a valid severity-of-asthma index at emergency department presentation',
          citation: 'Ducharme FM et al. J Pediatr. 2008',
          year: 2008,
          pmid: '19047225',
  ...
  // ─── 8. WIfI ───────────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      selectInput('wound', 'Wound (W)', [
        { label: '0 — No ulcer, no gangrene (ischemic rest pain only)', value: 0, points: 0 },
        { label: '1 — Small shallow ulcer; no exposed bone (unless distal phalanx); no gangrene', value: 1, points: 1 },
        { label: '2 — Deeper ulcer ± exposed bone/joint/tendon; gangrene limited to digits', value: 2, points: 2 },
        { label: '3 — Extensive deep ulcer / forefoot–midfoot gangrene / extensive heel necrosis', value: 3, points: 3 },
      ]),
      selectInput('ischemia', 'Ischemia (I)', [
        { label: '0 — ABI >0.80, toe pressure ≥60 mmHg', value: 0, points: 0 },
        { label: '1 — ABI 0.60–0.79, toe pressure 40–59 mmHg', value: 1, points: 1 },
        { label: '2 — ABI 0.40–0.59, toe pressure 30–39 mmHg', value: 2, points: 2 },
        { label: '3 — ABI <0.40, toe pressure <30 mmHg', value: 3, points: 3 },
      ]),
      selectInput('infection', 'foot Infection (fI)', [
        { label: '0 — Uninfected', value: 0, points: 0 },
        { label: '1 — Mild (skin/subcut only, erythema ≤2 cm)', value: 1, points: 1 },
        { label: '2 — Moderate (deeper or erythema >2 cm)', value: 2, points: 2 },
        { label: '3 — Severe (SIRS / systemic infection)', value: 3, points: 3 },
      ]),
    ],
    calculate(values) {
  ...
  // ─── 10. CARG chemo toxicity ───────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      yesNo('hearing', 'Hearing fair, poor, or deaf', 2),
      yesNo('falls', '≥1 fall in the past 6 months', 3),
      yesNo('limitedWalk', 'Limited in walking 1 block', 2),
      yesNo('medsHelp', 'Needs assistance taking medications', 1),
      yesNo('socialDec', 'Decreased social activity because of health', 1),
    ],
    calculate(values) {
  ...
  // ─── 11. NHS PREDICT breast (educational) ──────────────────────────────────
  {
    ...
    inputs: [
      ...
      selectInput('ki67', 'Ki67', [
        { label: 'Unknown / not used', value: 'unknown' },
        { label: 'Low (<10%)', value: 'low' },
        { label: 'High (≥10%)', value: 'high' },
      ]),
      selectInput('detection', 'Mode of detection', [
        { label: 'Symptomatic', value: 'symptom' },
        { label: 'Screen-detected', value: 'screen' },
      ]),
      selectInput('chemoGen', 'Adjuvant chemotherapy generation', [
        { label: 'None', value: 0 },
        { label: '2nd generation (e.g. AC, FEC60)', value: 2 },
        { label: '3rd generation (taxane / dose-dense)', value: 3 },
      ]),
    ],
    calculate(values) {
  ...
  // ─── 12. Leibovich 2018 RCC ────────────────────────────────────────────────
  {
    ...
    inputs: [
      selectInput('tStage', 'Pathologic T stage', [
        { label: 'pT1a', value: 0, points: 0 },
        { label: 'pT1b', value: 2, points: 2 },
        { label: 'pT2a', value: 3, points: 3 },
        { label: 'pT2b', value: 4, points: 4 },
        { label: 'pT3a', value: '3a', points: 4 },
        { label: 'pT3b', value: '3b', points: 4 },
        { label: 'pT3c / pT4', value: 6, points: 6 },
      ]),
      selectInput('nStage', 'Pathologic N stage', [
        { label: 'pNx / pN0', value: 0, points: 0 },
        { label: 'pN1', value: 2, points: 2 },
      ]),
      numberInput('sizeCm', 'Tumor size', {
        ...
        step: 0.5,
        defaultValue: 4,
        helpText: '+1 if ≥10 cm (Leibovich integer models).',
      }),
      selectInput('grade', 'WHO/ISUP (or Fuhrman) grade', [
        { label: 'Grade 1–2', value: 0, points: 0 },
        { label: 'Grade 3', value: 1, points: 1 },
        { label: 'Grade 4', value: 3, points: 3 },
      ]),
      yesNo('necrosis', 'Coagulative tumor necrosis', 2),
    ],
    calculate(values) {
  ...
  // ─── 13. ACEF II ───────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      ...
      numberInput('cr', 'Serum creatinine', { unit: 'mg/dL', min: 0.3, max: 12, step: 0.1, defaultValue: 1 }),
  ...
  // ─── 14. SYNTAX II ─────────────────────────────────────────────────────────
  {
    ...
    inputs: [
      numberInput('syntaxScore', 'Anatomical SYNTAX score', { min: 0, max: 60, defaultValue: 22 }),
  ...
  // ─── 15. Anatomical SYNTAX (simplified helper) ─────────────────────────────
  {
    ...
    inputs: [
      ...
      yesNo('cto', 'Any chronic total occlusion', null),
      yesNo('bifurcation', 'Any Medina bifurcation lesion', null),
      yesNo('calcium', 'Heavy calcification', null),
      yesNo('longLesion', 'Long lesion (>20 mm)', null),
      yesNo('aortoOstial', 'Aorto-ostial lesion', null),
      yesNo('thrombus', 'Thrombus-containing lesion', null),
      yesNo('tortuosity', 'Severe tortuosity', null),
    ],
    calculate(values) {
      ...
      references: [
        {
          ...
          citation: 'Sianos G et al. EuroIntervention. 2005',
          year: 2005,
          pmid: '19758907',
          doi: '10.4244/EIJV1I2A23',
        },
      ],
    },
    nextSteps: [
