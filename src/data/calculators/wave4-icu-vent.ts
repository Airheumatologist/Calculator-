...
export const wave4IcuVentCalcs: Calculator[] = [
      ...
      references: [
        {
          ...
          citation: 'Treacher DF, Leach RM. BMJ. 1998',
          year: 1998,
          pmid: '9804723',
          doi: '10.1136/bmj.317.7168.1302',
        },
        {
          title: 'The oxygen and carbon monoxide capacities of fetal and adult blood',
          citation: 'Gregory IC. J Physiol. 1974 (Hüfner constant / O₂ binding capacity)',
          year: 1974,
          pmid: '4822578',
          doi: '10.1113/jphysiol.1974.sp010456',
        },
      ],
    },
    nextSteps: [
  ...
  // 2. Mixed venous oxygen content (CvO₂)
  {
    ...
    evidence: {
      ...
      references: [
        {
          title: 'Mixed venous oxygen saturation. Its role in the assessment of the critically ill patient',
          citation: 'Kandel G, Aberman A. Arch Intern Med. 1983',
          year: 1983,
          pmid: '6870412',
  ...
  // 3. Oxygen extraction ratio
  {
    ...
    evidence: {
      ...
      references: [
        {
          title: 'The concept of a critical oxygen delivery',
          citation: 'Schumacker PT, Cain SM. Intensive Care Med. 1987',
          year: 1987,
          pmid: '3301969',
          doi: '10.1007/BF00265110',
        },
        {
          title: 'Oxygen transport-1. Basic principles',
          citation: 'Treacher DF, Leach RM. BMJ. 1998',
      ...
      references: [
        {
          ...
          citation: 'Lucangelo U, Bernabé F, Blanch L. Respir Care. 2005',
          year: 2005,
          pmid: '15636645',
        },
        {
          title: 'Mechanics of breathing in man',
          citation: 'Otis AB, Fenn WO, Rahn H. J Appl Physiol. 1950',
          year: 1950,
          pmid: '15436363',
      ...
      references: [
        {
          ...
          citation: 'Lourens MS et al. Intensive Care Med. 2000',
          year: 2000,
          pmid: '11193266',
      ...
      references: [
        {
          ...
          citation: 'Royal College of Physicians. Report of a working party. London: RCP; 2012',
          year: 2012,
          url: 'https://www.ombudsman.org.uk/sites/default/files/National%20Early%20Warning%20Score%20%28NEWS%29%20-%20Standardising%20the%20assessment%20of%20acute-illness%20severity%20in%20the%20NHS_0.pdf',
        },
        {
          ...
          citation: 'Smith GB et al. Resuscitation. 2013',
          year: 2013,
          pmid: '23295778',
  ...
  // 16. SALT mass casualty triage
  {
    ...
    inputs: [
      selectInput('walk', 'Can the casualty walk to a designated area?', [
        { label: 'Yes → Minimal (Green) group for secondary sort', value: 'walk', description: 'Able to walk to a designated area on command — global sort to Minimal (Green) for later individual assessment; still re-triage if they deteriorate' },
        { label: 'No — individual assessment', value: 'no', description: 'Cannot walk (includes those who only wave or are still). Proceed to LSI then individual assessment — do not assign Green here' },
      ], undefined, 'SALT global sort (Lerner): anyone who can walk is Minimal (Green) for secondary sort. Wave/purposeful movement and still/unresponsive casualties get individual assessment next (still first).'),
      selectInput('breathing', 'Breathing after airway opening / LSI?', [
        { label: 'Not applicable (walker)', value: 'na', description: 'Skip if already Green by walking' },
      ...
      ], undefined, 'After LSI, any of: does not obey commands, no peripheral pulse, respiratory distress, or uncontrolled major hemorrhage → Immediate (Red). N/A if walker.'),
      selectInput('pulse', 'Peripheral pulse present?', [
        { label: 'Yes / N/A walker', value: 'yes', description: 'Radial (or other peripheral) pulse palpable, or N/A if walker' },
        { label: 'No', value: 'no', description: 'No peripheral pulse → Immediate physiology (unless expectant)' },
      ], undefined, 'Palpate a peripheral pulse (radial typical). Absent pulse is Immediate physiology. N/A if walker.'),
      selectInput('distress', 'Respiratory distress or uncontrolled major hemorrhage?', [
        { label: 'No / N/A walker', value: 'no', description: 'Breathing comfortably and major bleeding controlled (or N/A if walker)' },
        { label: 'Yes', value: 'yes', description: 'Labored/rapid breathing, or major hemorrhage not controlled with LSI → Immediate physiology' },
      ], undefined, 'Respiratory distress = labored, very rapid, or inadequate breathing. Uncontrolled major hemorrhage = life-threatening bleed not controlled with pressure/tourniquet. Either is Immediate. N/A if walker.'),
      selectInput('likelySurvive', 'Likely to survive given current resources? (for expectant decision)', [
        { label: 'Yes / unknown / N/A', value: 'yes', description: 'Likely to survive with available resources, unknown, or N/A (not Immediate / walker)' },
        { label: 'No — expectant with current resources', value: 'no', description: 'Meets Immediate physiology but injuries are unsurvivable with current resources → Expectant (Gray); re-triage if resources improve' },
      ], undefined, 'Use only after Immediate physiology is present. Expectant is resource-based, not a declaration of death. Prefer Yes/unknown unless clearly unsurvivable now.'),
    ],
    calculate(values) {
  ...
  // 17. JumpSTART pediatric triage
  {
    ...
    inputs: [
      selectInput('ambulate', 'Able to walk?', [
        { label: 'Yes', value: 'yes', description: 'Child walks to a designated area → Minor (Green); still secondary-triage' },
        { label: 'No', value: 'no', description: 'Cannot walk, including infants/toddlers who are developmentally non-ambulatory — proceed down the algorithm; do not assign Green' },
      ], undefined, 'JumpSTART (typically ≤8 y or Broselow low-point). Infants who cannot walk skip Green and go to breathing. Ambulatory children = Minor (Green). Adults use START/SALT.'),
      selectInput('breatheSpont', 'Spontaneous breathing?', [
        { label: 'Yes / N/A walker', value: 'yes', description: 'Breathing without airway maneuvers, or N/A if already Green by walking' },
        { label: 'No', value: 'no', description: 'Apneic — open/position the airway next' },
      ], undefined, 'If not walking: is the child breathing? If yes, skip airway steps and go to RR. If no, position the airway (jaw thrust / sniffing). N/A if walker.'),
      selectInput('afterPosition', 'If apneic: breathing after airway position?', [
        { label: 'N/A (was breathing or walker)', value: 'na', description: 'Skip if already breathing or Green walker' },
        { label: 'Yes → Immediate', value: 'yes', description: 'Breathing resumes after airway opening → Immediate (Red)' },
        { label: 'No', value: 'no', description: 'Still apneic — check pulse next' },
      ], undefined, 'Open the airway. If breathing starts, tag Immediate. If still apneic, feel for a pulse.'),
      selectInput('pulseIfApnea', 'If still apneic: palpable pulse?', [
        { label: 'N/A', value: 'na', description: 'Skip unless still apneic after airway position' },
        { label: 'No → Deceased', value: 'no', description: 'No palpable pulse while apneic after airway → Deceased (Black)' },
        { label: 'Yes — give 5 rescue breaths then reassess breathing', value: 'yes', description: 'Pulse present but still apneic → give 5 rescue breaths, then reassess breathing' },
      ], undefined, 'JumpSTART unique step: apneic child WITH a pulse gets 5 rescue breaths (not a START step). No pulse → Deceased.'),
      selectInput('afterBreaths', 'After 5 rescue breaths: breathing?', [
        { label: 'N/A', value: 'na', description: 'Skip unless 5 rescue breaths were given' },
        { label: 'Yes → Immediate', value: 'yes', description: 'Breathing after 5 breaths → Immediate (Red)' },
        { label: 'No → Deceased', value: 'no', description: 'Still apneic after 5 breaths → Deceased (Black)' },
      ], undefined, 'Reassess only after the 5 rescue breaths. Breathing = Immediate; still apneic = Deceased.'),
      selectInput('rr', 'Respiratory rate (if breathing)', [
        { label: 'N/A walker', value: 'na', description: 'Skip if Green walker or in the apnea/deceased branch' },
        { label: '15–45 /min', value: 'ok', description: 'JumpSTART normal pediatric RR band — go to pulse then AVPU' },
        { label: '<15 or >45 /min', value: 'bad', description: 'Too slow or too fast → Immediate (Red)' },
      ], undefined, 'Count RR in a spontaneously breathing non-walker. JumpSTART Immediate if <15 or >45 /min (unlike adult START <10 or >30).'),
      selectInput('perfusion', 'Palpable peripheral pulse? (breathing child)', [
        { label: 'N/A walker', value: 'na', description: 'Skip if walker or already tagged from apnea/RR' },
        { label: 'Yes', value: 'yes', description: 'Peripheral pulse present — go to AVPU' },
        { label: 'No', value: 'no', description: 'No peripheral pulse in a breathing child → Immediate (Red)' },
      ], undefined, 'Palpate a peripheral pulse (not capillary refill — JumpSTART dropped CRT vs original START). Absent pulse = Immediate. N/A if walker.'),
  ...
  // 18. Nu-DESC nursing delirium
  {
    ...
    inputs: [
      selectInput('disorientation', 'Disorientation', [
        { label: '0 — Absent', value: 0, description: 'Oriented to time, place, and persons' },
        { label: '1 — Mild', value: 1, description: 'Present: verbal or behavioral lack of orientation to time or place, or misperceiving persons' },
        { label: '2 — Severe', value: 2, description: 'Pronounced disorientation throughout the shift' },
      ], 0, 'Score the current nursing shift. 0 = absent, 1 = present mild, 2 = pronounced. Disorientation: verbal/behavioral lack of orientation to time or place, or misperceiving persons.'),
      selectInput('behavior', 'Inappropriate behavior', [
        { label: '0 — Absent', value: 0, description: 'Behavior appropriate to place and person' },
        { label: '1 — Mild', value: 1, description: 'Present: pulling tubes/dressings or getting out of bed when contraindicated' },
        { label: '2 — Severe', value: 2, description: 'Pronounced inappropriate behavior (repeated/unsafe pulling or climbing)' },
      ], 0, 'Score the current nursing shift. Behavior: pulling tubes or dressings, or getting out of bed when that is contraindicated.'),
      selectInput('communication', 'Inappropriate communication', [
        { label: '0 — Absent', value: 0, description: 'Speech appropriate and intelligible' },
        { label: '1 — Mild', value: 1, description: 'Present: incoherence, non-communicativeness, or nonsensical/unintelligible speech' },
        { label: '2 — Severe', value: 2, description: 'Pronounced communication failure (little to no coherent speech)' },
      ], 0, 'Score the current nursing shift. Communication: incoherence, non-communicativeness, nonsensical or unintelligible speech.'),
      selectInput('illusion', 'Illusion / hallucination', [
        { label: '0 — Absent', value: 0, description: 'No perceptual disturbance' },
        { label: '1 — Mild', value: 1, description: 'Present: seeing or hearing things that are not there, or visual distortions' },
        { label: '2 — Severe', value: 2, description: 'Pronounced hallucinations/illusions' },
      ], 0, 'Score the current nursing shift. Illusion: seeing or hearing things not there / visual distortions.'),
      selectInput('psychomotor', 'Psychomotor retardation', [
        { label: '0 — Absent', value: 0, description: 'Normal spontaneous movement and speech' },
        { label: '1 — Mild', value: 1, description: 'Present: delayed responsiveness, few spontaneous actions/words' },
        { label: '2 — Severe', value: 2, description: 'Pronounced: deferred reaction when prodded, or unarousable' },
      ], 0, 'Score the current nursing shift. Psychomotor retardation: delayed responsiveness, few spontaneous actions/words; deferred reaction when prodded or unarousable.'),
    ],
    calculate(values) {
      const score =
  ...
  // 19. Riker SAS
  {
    ...
    inputs: [
      selectInput('sas', 'SAS level', [
        { label: '1 — Unarousable (minimal/no response to noxious stimuli)', value: 1, description: 'Minimal or no response to noxious stimuli; does not communicate or follow commands' },
        { label: '2 — Very sedated (arouses to physical stimuli only)', value: 2, description: 'Arouses to physical stimuli but does not communicate or follow commands; may move spontaneously' },
        { label: '3 — Sedated (difficult to arouse; follows simple commands)', value: 3, description: 'Awakens to verbal stimuli or gentle shaking then drifts off again; follows simple commands' },
        { label: '4 — Calm and cooperative', value: 4, description: 'Calm, awakens easily, follows commands' },
        { label: '5 — Agitated (anxious or mildly agitated)', value: 5, description: 'Anxious or mildly agitated, attempting to sit up; calms to verbal instructions' },
        { label: '6 — Very agitated (requires restraints / frequent airway protection)', value: 6, description: 'Does not calm despite frequent verbal reminding of limits; requires physical restraints; biting ET tube' },
        { label: '7 — Dangerous agitation (pulling lines, thrashing, combative)', value: 7, description: 'Pulling ET tube/catheters, climbing bedrail, striking staff, thrashing side-to-side' },
      ], 1, 'Usual mis-scores: 5 calms to verbal limits vs 6 does not calm despite frequent verbal reminding. 3 awakens to voice/gentle shaking then drifts; 2 arouses to physical stimuli but does not follow commands.'),
    ],
    calculate(values) {
    ...
    evidence: {
      ...
      references: [
        {
          title: 'Prospective evaluation of the Sedation-Agitation Scale for adult critically ill patients',
          citation: 'Riker RR, Picard JT, Fraser GL. Crit Care Med. 1999',
          year: 1999,
          pmid: '10446827',
  ...
  // 20. ICDSC delirium checklist
  {
    ...
    inputs: [
      yesNo('ams', 'Altered level of consciousness (not alert/calm; or RASS/SAS not 0/4)', 1, '0 if RASS 0 / SAS 4. Score 1 if drowsy (RASS −1 to −3 / SAS 3) or agitated (RASS +1 to +4 / SAS 5–7). If no response or only to intense pain (RASS −4/−5, SAS 1–2) record UTA and do not complete other items — this screen still has no UTA choice, so do not score coma as 1.'),
      yesNo('inattention', 'Inattention', 1, 'Difficulty following a conversation or instructions; easily distracted; difficulty shifting focus'),
      yesNo('disorientation', 'Disorientation', 1, 'Any obvious mistake in person, place, or time'),
      yesNo('hallucination', 'Hallucination / delusion / psychosis', 1, 'Unequivocal hallucination, delusion, or psychosis'),
      yesNo('psychomotor', 'Psychomotor agitation or retardation', 1, 'Hyperactivity requiring extra sedation or restraints, or hypoactivity'),
      yesNo('speech', 'Inappropriate speech or mood', 1, 'Inappropriate, disorganized, or incoherent speech, or inappropriate mood/emotion'),
      yesNo('sleep', 'Sleep–wake cycle disturbance', 1, '<4 h sleep at night, frequent nocturnal waking (exclude staff/noise), or sleeping most of the day'),
      yesNo('fluctuation', 'Symptom fluctuation', 1, 'Any item 1–7 fluctuating over 24 h (shift to shift)'),
    ],
    calculate(values) {
  ...
  // 21. Braden scale
  {
    ...
    inputs: [
      selectInput('sensory', 'Sensory perception', [
        { label: '1 — Completely limited', value: 1, description: 'Unresponsive to painful stimuli (does not moan, flinch, or grasp)' },
        { label: '2 — Very limited', value: 2, description: 'Responds only to pain; cannot communicate discomfort except moaning/restlessness' },
        { label: '3 — Slightly limited', value: 3, description: 'Verbal but cannot always report discomfort, or limited sensory loss in 1–2 extremities' },
        { label: '4 — No impairment', value: 4, description: 'Responds to commands; no sensory deficit limiting pain reporting' },
      ], 1, 'Score from the official Braden card (Prevention Plus, copyrighted). Titles here are not sufficient to distinguish 1 vs 2 vs 3 vs 4. Reminder: unresponsive vs pain-only vs verbal but cannot always report discomfort.'),
      selectInput('moisture', 'Moisture', [
        { label: '1 — Constantly moist', value: 1, description: 'Skin kept moist almost constantly; linen changed at every turning' },
        { label: '2 — Often moist', value: 2, description: 'Linen must be changed at least once per shift' },
        { label: '3 — Occasionally moist', value: 3, description: 'Extra linen change about once a day' },
        { label: '4 — Rarely moist', value: 4, description: 'Usually dry; routine linen intervals' },
      ], 1, 'Score from the official Braden card. Operational reminder: moisture ≈ linen-change frequency (every turn vs ≥1×/shift vs ~1×/day vs rarely).'),
      selectInput('activity', 'Activity', [
        { label: '1 — Bedfast', value: 1, description: 'Confined to bed' },
        { label: '2 — Chairfast', value: 2, description: 'Walking severely limited or nonexistent; cannot bear own weight — chair or wheelchair' },
        { label: '3 — Walks occasionally', value: 3, description: 'Walks occasionally, very short distances, with or without help; most of shift in bed or chair' },
        { label: '4 — Walks frequently', value: 4, description: 'Walks outside the room ≥twice/day and inside the room at least every 2 h while awake' },
      ], 1, 'Score from the official Braden card. Walks frequently = outside room ≥twice/day and inside every 2 h vs short distances only vs chairfast vs bedfast.'),
      selectInput('mobility', 'Mobility', [
        { label: '1 — Completely immobile', value: 1, description: 'Does not make even slight independent position changes' },
        { label: '2 — Very limited', value: 2, description: 'Occasional slight changes only; cannot make frequent or significant independent changes' },
        { label: '3 — Slightly limited', value: 3, description: 'Makes frequent though slight independent position changes' },
        { label: '4 — No limitation', value: 4, description: 'Makes major and frequent independent position changes' },
      ], 1, 'Score from the official Braden card. Distinguish no independent position change vs occasional slight vs frequent slight vs unlimited.'),
      selectInput('nutrition', 'Nutrition', [
        { label: '1 — Very poor', value: 1, description: 'Rarely eats more than ⅓ of meals, or NPO/clears/IV >5 days' },
        { label: '2 — Probably inadequate', value: 2, description: 'Generally eats only about ½ of food offered' },
        { label: '3 — Adequate', value: 3, description: 'Eats over half of most meals, or tube/TPN meeting most needs' },
        { label: '4 — Excellent', value: 4, description: 'Eats most of every meal; does not require supplements' },
      ], 1, 'Score from the official Braden card. NPO or clear liquids >5 days counts as very poor nutrition. Do not reprint the full official descriptors here.'),
      selectInput('friction', 'Friction & shear', [
        { label: '1 — Problem', value: 1, description: 'Maximum assist to move; frequent sliding down in bed or chair' },
        { label: '2 — Potential problem', value: 2, description: 'Minimum assist; occasional sliding; maintains position most of the time' },
        { label: '3 — No apparent problem', value: 3, description: 'Independent lift during moves; maintains good position' },
      ], 1, 'Score from the official Braden card (friction is 1–3 only). Reminder: max assist + frequent sliding vs min assist + occasional slide vs independent lift.'),
    ],
    calculate(values) {
      const score =
    ...
    evidence: {
      ...
      references: [
        {
          title: 'A clinical trial of the Braden Scale for Predicting Pressure Sore Risk',
          citation: 'Bergstrom N, Demuth PJ, Braden BJ. Nurs Clin North Am. 1987',
          year: 1987,
          pmid: '3554150',
        },
      ],
  ...
  // 22. Waterlow scale
  {
    ...
    inputs: [
      selectInput('build', 'Build / weight for height', [
        { label: 'Average — BMI 20–24.9 (0)', value: 0 },
        { label: 'Above average — BMI 25–29.9 (1)', value: 1 },
        { label: 'Obese — BMI ≥30 (2)', value: 2 },
      ...
      selectInput('continence', 'Continence', [
        ...
        { label: 'Catheterized + incontinent of feces (2)', value: 2, description: 'Urinary catheter in situ but incontinent of feces' },
        { label: 'Doubly incontinent (3)', value: 3, description: 'Incontinent of both urine and feces' },
      ], 0, 'Score from the official Waterlow card. Catheter with continent stool = 0; catheter plus fecal incontinence = 2; urine and stool = 3.'),
      selectInput('mobility', 'Mobility', [
        { label: 'Fully (0)', value: 0, description: 'Walks independently' },
        { label: 'Restless / fidgety (1)', value: 1, description: 'Can move but restless/fidgety' },
        { label: 'Apathetic (2)', value: 2, description: 'Apathetic; limited spontaneous movement' },
        { label: 'Restricted (3)', value: 3, description: 'Restricted movement' },
        { label: 'Inert / traction (4)', value: 4, description: 'Immobile or in traction' },
        { label: 'Chairbound (5)', value: 5, description: 'Chairbound — highest mobility item on this card' },
      ], 0, 'Score from the official Waterlow card. Chairbound is the highest mobility item (5).'),
      selectInput('appetite', 'Appetite / nutrition', [
        { label: 'Average (0)', value: 0, description: 'Eats a normal diet / usual portions' },
        { label: 'Poor (1)', value: 1, description: 'Eats poorly; leaves much of meals uneaten' },
        { label: 'NG / fluids only (2)', value: 2, description: 'Nasogastric feeding or fluids only — no solid intake' },
  ...
  // 23. Norton scale
  {
    ...
    inputs: [
      selectInput('physical', 'Physical condition', [
        { label: '4 — Good', value: 4, description: 'Good for age' },
        { label: '3 — Fair', value: 3, description: 'Medical problems, fair condition' },
        { label: '2 — Poor', value: 2, description: 'Poor — multiple or poorly controlled illness' },
        { label: '1 — Very bad', value: 1, description: 'Very bad / moribund' },
      ], 4, 'Operational: 4 = good for age; 3 = medical problems, fair condition; 2 = poor, multiple or poorly controlled illness; 1 = very bad/moribund.'),
      selectInput('mental', 'Mental condition', [
        { label: '4 — Alert', value: 4, description: 'Alert, oriented' },
        { label: '3 — Apathetic', value: 3, description: 'Apathetic = disinterested, withdrawn' },
        { label: '2 — Confused', value: 2, description: 'Confused, disoriented' },
        { label: '1 — Stuporous', value: 1, description: 'Stuporous = responds only to vigorous stimulation' },
      ], 4, 'Apathetic = disinterested; stuporous = responds only to vigorous stimulation.'),
      selectInput('activity', 'Activity', [
        { label: '4 — Ambulant', value: 4, description: 'Walks independently (with or without a walking aid) for most of the day' },
        { label: '3 — Walks with help', value: 3, description: 'Walks only with assistance of another person' },
        { label: '2 — Chairbound', value: 2, description: 'Confined to a chair/wheelchair; does not walk' },
        { label: '1 — Bedbound', value: 1, description: 'Confined to bed' },
      ], 4, 'Activity is how far the patient gets, not in-bed mobility (that is the next item). Ambulant vs needs a helper vs chair vs bed.'),
      selectInput('mobility', 'Mobility', [
        { label: '4 — Full', value: 4, description: 'Full independent position change' },
        { label: '3 — Slightly limited', value: 3, description: 'Frequent small independent position changes' },
        { label: '2 — Very limited', value: 2, description: 'Occasional slight independent changes only' },
        { label: '1 — Immobile', value: 1, description: 'No independent position change' },
      ], 4, '4 = full independent position change; 3 = frequent small changes; 2 = occasional slight changes only; 1 = no independent change.'),
      selectInput('incontinence', 'Incontinence', [
        { label: '4 — None', value: 4, description: 'Continent of urine and stool, or fully catheter/diverted and dry' },
        { label: '3 — Occasional', value: 3, description: 'Occasional incontinence (not every void/stool)' },
        { label: '2 — Usually urinary', value: 2, description: 'Usually incontinent of urine (most voids)' },
        { label: '1 — Urinary and fecal', value: 1, description: 'Incontinent of both urine and feces' },
      ], 4, 'Occasional = not every episode; usually urinary = most voids; 1 = dual incontinence.'),
    ],
    calculate(values) {
      const score =
      ...
      references: [
        {
          ...
          citation: 'Norton D, McLaren R, Exton-Smith AN. London: National Corporation for the Care of Old People; 1962',
          year: 1962,
        },
        {
          title: 'Pressure ulcers: prevention and management',
          citation: 'National Institute for Health and Care Excellence. NICE CG179. 2014',
          year: 2014,
  ...
  // 24. MUST malnutrition screening
  {
    ...
    inputs: [
      ...
      selectInput('wtLoss', 'Unplanned weight loss in past 3–6 months', [
        ...
        { label: '>10% (2)', value: 2, description: 'Unplanned loss >10% of usual weight over 3–6 months' },
      ], 0, 'Percent loss = (usual weight − current) / usual × 100 over the past 3–6 months. Planned intentional loss does not count. MUST is BAPEN copyright (free non-commercial).'),
      selectInput('acute', 'Acute disease effect', [
        {
          label: 'No — patient not acutely ill and no likelihood of no intake >5 days (0)',
          value: 0,
          description: 'Eating, or expected to eat, within 5 days; or not acutely ill',
        },
        {
          label: 'Yes — acutely ill AND likely no nutritional intake for >5 days (2)',
          value: 2,
          description: 'Both required: currently acutely ill AND unlikely to have any nutritional intake for more than 5 days (e.g., NPO, unconscious, or bowel rest)',
        },
    ...
    evidence: {
      ...
      references: [
        {
          title: "The 'MUST' report: Nutritional screening of adults — a multidisciplinary responsibility",
          citation: 'Elia M; Malnutrition Advisory Group, BAPEN. 2003',
          year: 2003,
        ...
        },
        {
          ...
          citation: 'Stratton RJ et al. Br J Nutr. 2004',
          year: 2004,
          pmid: '15533269',
